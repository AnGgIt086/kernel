...
s32 buf_init(struct super_block *sb)
{
    ...
    /*split exfat_sb_info into small size < 32K to avoid alloc high order pages*/
    p_fs->buf_cache_array = kzalloc(sizeof(*p_fs->buf_cache_array) * BUF_CACHE_SIZE, GFP_KERNEL);
