...
#define DISPLAY_FPS_FILTER_NUM 4//vivo mhy add patch for rear video
...
#define FSTB_IDLE_DBNC 10//vivo mhy add patch for rear video
...
struct FSTB_FRAME_INFO {
	...
	int fps_raise_flag;
	int render_idle_cnt;//vivo mhy add patch for rear video
};
