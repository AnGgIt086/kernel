...
{
       LCM_INFO("[LCM]2140jf boe_nt36525b- init begin \n");
       lcm_reset_setting(1);
       MDELAY(3);
       lcm_reset_setting(0);
       MDELAY(3);
...
struct LCM_DRIVER pd2140jf_boe_nt36525b_noflash_hdp_dsi_vdo_lcm_drv = {
       .name = "pd2140jf_boe_nt36525b_noflash_hdp_dsi_vdo",
