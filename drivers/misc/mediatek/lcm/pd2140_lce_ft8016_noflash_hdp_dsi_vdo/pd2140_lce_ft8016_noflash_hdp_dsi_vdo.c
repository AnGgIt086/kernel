...
static struct LCM_setting_table init_setting_12bit[] = {
	...
	{0x90, 16, {0x00,0x1B,0x42,0x0A,0xE3,0x91,0xA4,0xF0,0xB9,0x61,0x69,0x20,0x69,0x81,0x26,0x00} },
	...
	{0x41, 2, {0x5A,0x0A} },
	{0x80, 16, {0xFF,0x84,0x8F,0x03,0x00,0x11,0x1A,0x2D,0x3E,0x4F,0x56,0x88,0x64,0xA1,0x93,0x5B} },
	{0x90, 16, {0x87,0x5A,0x56,0x45,0x34,0x24,0x16,0x0B,0x00,0x11,0x1A,0x2D,0x3E,0x4F,0x56,0x88} },
	{0xA0, 13, {0x64,0xA1,0x93,0x5B,0x87,0x5A,0x56,0x45,0x34,0x24,0x16,0x0B,0x00} },
	{0x41, 2, {0x5A,0x0B} },
	...
	{0x90, 16, {0xF3,0x00,0x20,0xCB,0x85,0xAA,0xD5,0x06,0x91,0x91,0x77,0xA1,0x6A,0xB5,0x41,0x64} },
	{0xA0, 16, {0x64,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x90} },
	{0xB0, 16, {0x75,0xA1,0x6A,0xB5,0x00,0x00,0x00,0x40,0x12,0x00,0x00,0x00,0x80,0xD6,0x0C,0x4D} },
	{0xC0, 16, {0xC9,0x22,0x41,0xC1,0x50,0x9C,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0xC9,0xD0} },
	{0xD0, 16, {0xA4,0x20,0x13,0x64,0x10,0x02,0x68,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0xD6,0x0C} },
	{0xE0, 16, {0x4D,0x88,0x22,0x41,0x80,0x40,0x98,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0xC9} },
	{0xF0, 16, {0xD0,0xB4,0x24,0x13,0x74,0x14,0x43,0x68,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0x5B,0xD2} },
	{0x41, 2, {0x5A,0x16} },
	{0x80, 16, {0xC3,0xC3,0xC3,0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00} },
	...
	//Dgamma
	{0x80, 16, {0x00,0x04,0x08,0x0C,0x00,0x10,0x14,0x18,0x1C,0x40,0x20,0x29,0x31,0x3A,0x72,0x42} },
	{0x90, 16, {0x4B,0x53,0x5B,0x97,0x64,0x6C,0x74,0x7C,0x84,0x84,0x8D,0x94,0x9D,0x33,0xA5,0xAC} },
	{0xA0, 16, {0xB4,0xBC,0xAC,0xC4,0xCC,0xD3,0xDB,0xB1,0xE3,0xEA,0xF2,0xF9,0x09,0xFC,0xFE,0xFF} },
	{0xB0, 16, {0x01,0x00,0x04,0x08,0x0C,0x00,0x10,0x14,0x18,0x1C,0x00,0x20,0x28,0x31,0x39,0x4D} },
	{0xC0, 16, {0x41,0x49,0x51,0x59,0xFA,0x62,0x6A,0x72,0x7A,0x94,0x82,0x8B,0x93,0x9B,0x03,0xA3} },
	{0xD0, 16, {0xAB,0xB3,0xBB,0x05,0xC2,0xCA,0xD2,0xDA,0xAF,0xE2,0xEA,0xF1,0xF8,0xE1,0xFC,0xFE} },
	{0xE0, 16, {0xFF,0x2A,0x00,0x04,0x08,0x0C,0x00,0x10,0x14,0x18,0x1C,0x00,0x20,0x28,0x30,0x38} },
	...
	{0x41, 2, {0x5A,0x24} },
	{0x80, 16, {0x00,0x03,0x00,0xFF,0xFF,0x20,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xB5,0x56} },
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_backporch = 60;//24
	params->dsi.horizontal_frontporch = 122;//36
...
{
	LCM_INFO("%s lce_ft8016 -> enter power on begin, panel_reset_state=%d\n", __func__, panel_reset_state);
	if (panel_reset_state == 0) {
		fts8016_fts_reset_lcm(1);
		MDELAY(2);
		lcm_reset_setting(1);
		MDELAY(2);
		fts8016_fts_reset_lcm(0);
		MDELAY(5);
		lcm_reset_setting(1);
		MDELAY(2);
		lcm_reset_setting(0);
	...
	************************************/
		...
		panel_reset_state = 1;
		LCM_INFO("%s lce_ft8016 -> enter power on end\n", __func__);
	} else {
		fts8016_fts_reset_lcm(1);
		MDELAY(2);
		lcm_reset_setting(1);
		...
		lcm_reset_setting(0);
		MDELAY(5);
		LCM_INFO("%s lce_ft8016 -> reset low=%d\n", __func__, panel_reset_state);
	}
}
...
static void lcm_suspend_power(void)
{
	...
	lcm_enp_setting(0);
	MDELAY(5);
	LCM_INFO("[LCM]lcm_suspend_power lce_ft8016- vddi keep high level\n");
	panel_reset_state = 0;//clear reset state
}

static void lcm_init(void)
{
	LCM_INFO("[LCM]lce_ft8016- init begin\n");
	lcm_reset_setting(1);
	MDELAY(6);
	lcm_reset_setting(0);
	MDELAY(5);
	...
	******************************************************************/
	...
	LCM_INFO("[LCM]lce_ft8016- init end\n");
}
...
static void lcm_suspend(void)
{
	...
	1);
	panel_off_state = 1;
	LCM_INFO("[LCM]lce_ft8016- lcm_suspend display off\n");
}
...
static void lcm_reset_for_touch(void)
{
	...
	MDELAY(12);
	panel_reset_state = 1;
	LCM_INFO("[LCM]lce_ft8016- lcm_reset_for_touch end\n");
}
...
struct LCM_DRIVER pd2140_lce_ft8016_noflash_hdp_dsi_vdo_lcm_drv = {
	.name = "pd2140_lce_ft8016_noflash_hdp_dsi_vdo",
