...
static struct LCM_setting_table init_setting_12bit[] = {
	{0xFF, 1, {0x20} },
	{0xFB, 1, {0x01} },
	{0xB0, 16, {0x00 ,0x08 ,0x00 ,0x1D ,0x00 ,0x39 ,0x00 ,0x54 ,0x00 ,0x68 ,0x00 ,0x7E ,0x00 ,0x91 ,0x00 ,0x9F}},
	{0xB1, 16, {0x00 ,0xAE ,0x00 ,0xE2 ,0x01 ,0x0B ,0x01 ,0x4A ,0x01 ,0x7B ,0x01 ,0xC8 ,0x02 ,0x08 ,0x02 ,0x0A}},
	{0xB2, 16, {0x02 ,0x46 ,0x02 ,0x8A ,0x02 ,0xB6 ,0x02 ,0xEE ,0x03 ,0x12 ,0x03 ,0x3F ,0x03 ,0x4D ,0x03 ,0x5C}},
	{0xB3, 12, {0x03 ,0x6E ,0x03 ,0x84 ,0x03 ,0xA1 ,0x03 ,0xBB ,0x03 ,0xD6 ,0x03 ,0xDA}},
	{0xB4, 16, {0x00 ,0x44 ,0x00 ,0x50 ,0x00 ,0x67 ,0x00 ,0x7B ,0x00 ,0x8E ,0x00 ,0x9E ,0x00 ,0xAD ,0x00 ,0xBC}},
	{0xB5, 16, {0x00 ,0xC9 ,0x00 ,0xF6 ,0x01 ,0x1B ,0x01 ,0x56 ,0x01 ,0x85 ,0x01 ,0xCF ,0x02 ,0x0C ,0x02 ,0x0E}},
	{0xB6, 16, {0x02 ,0x4A ,0x02 ,0x8D ,0x02 ,0xB8 ,0x02 ,0xF0 ,0x03 ,0x13 ,0x03 ,0x3F ,0x03 ,0x4E ,0x03 ,0x5D}},
	{0xB7, 12, {0x03 ,0x6F ,0x03 ,0x86 ,0x03 ,0xA2 ,0x03 ,0xBB ,0x03 ,0xD6 ,0x03 ,0xDA}},
	{0xB8, 16, {0x00 ,0x08 ,0x00 ,0x1A ,0x00 ,0x3B ,0x00 ,0x54 ,0x00 ,0x69 ,0x00 ,0x7F ,0x00 ,0x92 ,0x00 ,0xA1}},
	{0xB9, 16, {0x00 ,0xB3 ,0x00 ,0xE7 ,0x01 ,0x10 ,0x01 ,0x4F ,0x01 ,0x7F ,0x01 ,0xCB ,0x02 ,0x09 ,0x02 ,0x0B}},
	{0xBA, 16, {0x02 ,0x47 ,0x02 ,0x8B ,0x02 ,0xB7 ,0x02 ,0xF1 ,0x03 ,0x12 ,0x03 ,0x44 ,0x03 ,0x57 ,0x03 ,0x5C}},
	{0xBB, 12, {0x03 ,0x6E ,0x03 ,0x85 ,0x03 ,0xA2 ,0x03 ,0xBB ,0x03 ,0xD6 ,0x03 ,0xDA}},
	{0xFF, 1, {0x21}},
	{0xFB, 1, {0x01}},
	{0xB0, 16, {0x00 ,0x00 ,0x00 ,0x15 ,0x00 ,0x31 ,0x00 ,0x4C ,0x00 ,0x60 ,0x00 ,0x76 ,0x00 ,0x89 ,0x00 ,0x97}},
	{0xB1, 16, {0x00 ,0xA6 ,0x00 ,0xDA ,0x01 ,0x03 ,0x01 ,0x42 ,0x01 ,0x73 ,0x01 ,0xC0 ,0x02 ,0x00 ,0x02 ,0x02}},
	{0xB2, 16, {0x02 ,0x3E ,0x02 ,0x82 ,0x02 ,0xAE ,0x02 ,0xE6 ,0x03 ,0x0A ,0x03 ,0x37 ,0x03 ,0x45 ,0x03 ,0x54}},
	{0xB3, 12, {0x03 ,0x66 ,0x03 ,0x7C ,0x03 ,0x99 ,0x03 ,0xB3 ,0x03 ,0xCE ,0x03 ,0xD2}},
	{0xB4, 16, {0x00 ,0x3C ,0x00 ,0x48 ,0x00 ,0x5F ,0x00 ,0x73 ,0x00 ,0x86 ,0x00 ,0x96 ,0x00 ,0xA5 ,0x00 ,0xB4}},
	{0xB5, 16, {0x00 ,0xC1 ,0x00 ,0xEE ,0x01 ,0x13 ,0x01 ,0x4E ,0x01 ,0x7D ,0x01 ,0xC7 ,0x02 ,0x04 ,0x02 ,0x06}},
	{0xB6, 16, {0x02 ,0x42 ,0x02 ,0x85 ,0x02 ,0xB0 ,0x02 ,0xE8 ,0x03 ,0x0B ,0x03 ,0x37 ,0x03 ,0x46 ,0x03 ,0x55}},
	{0xB7, 12, {0x03 ,0x67 ,0x03 ,0x7E ,0x03 ,0x9A ,0x03 ,0xB3 ,0x03 ,0xCE ,0x03 ,0xD2}},
	{0xB8, 16, {0x00 ,0x00 ,0x00 ,0x12 ,0x00 ,0x33 ,0x00 ,0x4C ,0x00 ,0x61 ,0x00 ,0x77 ,0x00 ,0x8A ,0x00 ,0x99}},
	{0xB9, 16, {0x00 ,0xAB ,0x00 ,0xDF ,0x01 ,0x08 ,0x01 ,0x47 ,0x01 ,0x77 ,0x01 ,0xC3 ,0x02 ,0x01 ,0x02 ,0x03}},
	{0xBA, 16, {0x02 ,0x3F ,0x02 ,0x83 ,0x02 ,0xAF ,0x02 ,0xE9 ,0x03 ,0x0A ,0x03 ,0x3C ,0x03 ,0x4F ,0x03 ,0x54}},
	{0xBB, 12, {0x03 ,0x66 ,0x03 ,0x7D ,0x03 ,0x9A ,0x03 ,0xB3 ,0x03 ,0xCE ,0x03 ,0xD2}},
...
{
	LCM_INFO("%s boe_nt36525b -> enter power on begin, panel_reset_state=%d\n", __func__, panel_reset_state);
	...
	************************************/
		...
		LCM_INFO("%s boe_nt36525b -> enter power on end\n", __func__);
	}
}
...
static void lcm_suspend_power(void)
{
	...
	lcm_enp_setting(0);
	MDELAY(5);
	LCM_INFO("[LCM]lcm_suspend_power boe_nt36525b- vddi keep high level\n");
	panel_reset_state = 0;// clear reset state
}

static void lcm_init(void)
{
	LCM_INFO("[LCM]boe_nt36525b- init begin\n");
	lcm_reset_setting(1);
	MDELAY(3);
	lcm_reset_setting(0);
	MDELAY(3);
	...
	******************************************************************/
	...
	LCM_INFO("[LCM]boe_nt36525b- init end\n");
}
...
static void lcm_suspend(void)
{
	push_table(lcm_suspend_setting,
		...
		1);
	panel_off_state = 1;
	LCM_INFO("[LCM]boe_nt36525b- lcm_suspend display off\n");
}
...
static void lcm_reset_for_touch(void)
{
	...
	MDELAY(12);
	panel_reset_state = 1;
	LCM_INFO("[LCM]boe_nt36525b- lcm_reset_for_touch end\n");
}
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
	...
	level = (level*834+500)/1000;
	/*Due to the addition of low brightness screen, the backlight current is 24mA -> 20ma*/
...
struct LCM_DRIVER pd2216_boe_nt36525b_hdp_dsi_vdo_lcm_drv = {
	.name = "pd2216_boe_nt36525b_hdp_dsi_vdo",
