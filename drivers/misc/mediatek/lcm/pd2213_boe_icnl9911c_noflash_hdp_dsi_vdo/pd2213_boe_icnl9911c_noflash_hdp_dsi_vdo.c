...
static struct LCM_setting_table init_setting_12bit[] = {
	...
	{0xE1, 23,{0xBD,0xEC,0xDC,0xFC,0xDC,0xCC,0xF0,0xFF,0x9A,0xC0,0x70,0x71,0xE0,0x00,0xE4,0xBC,0x7F,0xE1,0xB2,0xFF,0x00,0x08,0x37}},
	{0xE0, 26,{0x30,0x00,0x00,0x18,0x11,0x1F,0x22,0x62,0xDF,0xA0,0x04,0xCC,0x01,0xFF,0xFA,0xFF,0xF8,0xF8,0xFF,0xFA,0xF8,0xFA,0xFA,0xFA,0xFA,0xFF}},
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	if (rf_hw_id == 1) {
		...
		LCM_INFO("%s PD2213 rf_hw_id PLL_CLOCK %d\n", __func__, params->dsi.PLL_CLOCK);
	}
#endif
...
struct LCM_DRIVER pd2213_boe_icnl9911c_noflash_hdp_dsi_vdo_lcm_drv = {
	.name = "pd2213_boe_icnl9911c_noflash_hdp_dsi_vdo",
