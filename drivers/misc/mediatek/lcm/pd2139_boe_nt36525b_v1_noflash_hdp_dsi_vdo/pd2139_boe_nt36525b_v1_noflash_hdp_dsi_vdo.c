...
/*#endif*/
	...
	if ((!strcmp(project_name, "PD2139F_EX")) || (!strcmp(project_name, "PD2139F_EX_SC"))) {
...
{
	LCM_INFO("%s nt36525b v1 -> enter power on begin, panel_reset_state=%d\n", __func__, panel_reset_state);
	...
	************************************/
		...
		LCM_INFO("%s nt36525b v1 -> enter power on end\n", __func__);
	}
}
...
static void lcm_suspend_power(void)
{
	...
	lcm_enp_setting(0);
	MDELAY(5);
	LCM_INFO("[LCM]lcm_suspend_power nt36525b v1- vddi keep high level\n");
	panel_reset_state = 0;// clear reset state
}

static void lcm_init(void)
{
	LCM_INFO("[LCM]nt36525b v1- init begin\n");
	lcm_reset_setting(1);
	MDELAY(3);
	lcm_reset_setting(0);
	MDELAY(3);
	...
	******************************************************************/
	...
	LCM_INFO("[LCM]nt36525b v1- init end\n");
}
...
static void lcm_suspend(void)
{
	push_table(lcm_suspend_setting,
		...
		1);
	panel_off_state = 1;
	LCM_INFO("[LCM]nt36525b v1 - lcm_suspend display off\n");
}
...
struct LCM_DRIVER pd2139_boe_nt36525b_v1_noflash_hdp_dsi_vdo_lcm_drv = {
	.name = "pd2139_boe_nt36525b_v1_noflash_hdp_dsi_vdo",
