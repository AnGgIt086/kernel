...
#define LOG_TAG "LCM"
#define LOG_PANEL_TYPE "LCE+ICNL9911C"
...
static struct LCM_setting_table init_setting_12bit[] = {
	{0xF0, 2,{0x5A,0x59}},
	{0xF1, 2,{0xA5,0xA6}},
	{0xB0,32,{0x89,0x88,0x87,0x86,0x02,0x03,0x04,0x05,0x33,0x33,0x33,0x33,0x16,0x02,0x02,0x61,0x02,0x02,0x00,0x05,0x04,0x03,0x02,0x01,0x02,0x03,0x04,0x00,0x00,0x00,0x00,0x00}},
	{0xB1,32,{0x53,0x42,0x85,0x81,0x2C,0x02,0x02,0x77,0x02,0x02,0x04,0x08,0x54,0x00,0x00,0x00,0x44,0x40,0x02,0x01,0x40,0x02,0x01,0x40,0x02,0x01,0x40,0x02,0x01,0x00,0x00,0x00}},
	{0xB2,17,{0x54,0xC4,0x82,0x05,0x40,0x02,0x01,0x40,0x02,0x01,0x05,0x05,0x54,0x0C,0x0C,0x0D,0x0B}},
	{0xB3,32,{0x02,0x10,0x08,0x10,0x08,0x26,0x26,0x91,0xA2,0x33,0x44,0x00,0x26,0x00,0x18,0x01,0x02,0x08,0x20,0x30,0x0E,0x07,0x00,0x00,0x78,0x00,0x78,0x08,0x09,0x22,0x33,0x00}},
	{0xB4,28,{0x43,0x1D,0xE3,0x00,0x04,0x06,0x1C,0x22,0x10,0x12,0x0C,0x0E,0x43,0x43,0x43,0x43,0x43,0x43,0x43,0x43,0x43,0x43,0xFF,0xFF,0xFC,0x00,0x00,0x00}},
	{0xB5,28,{0x43,0x1D,0xE3,0x00,0x05,0x07,0x1C,0x22,0x11,0x13,0x0D,0x0F,0x43,0x43,0x43,0x43,0x43,0x43,0x43,0x43,0x43,0x43,0xFF,0xFF,0xFC,0x00,0x00,0x00}},
	...
	{0xBE,10,{0x73,0x87,0x32,0x5A,0x0C,0x77,0x43,0x07,0x0E,0x0E}},
	{0xBF, 8,{0x07,0x25,0x07,0x25,0x7F,0x00,0x11,0x04}},
	{0xC0, 9,{0x10,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0xFF,0x00}},
	{0xC1,19,{0xC0,0x20,0x20,0x96,0x04,0x6E,0x6E,0x04,0x2A,0x40,0x36,0x00,0x07,0xCF,0xFF,0xFF,0xC0,0x00,0xC0}},
	{0xC2, 1,{0x00}},
	{0xC3, 9,{0x06,0x00,0xFF,0x00,0xFF,0x00,0x00,0x81,0x01}},
	{0xC4,10,{0x84,0x01,0x2B,0x41,0x00,0x3C,0x00,0x03,0x03,0x2E}},
	{0xC5,11,{0x03,0x1C,0xC0,0xA0,0x80,0x10,0x42,0x44,0x08,0x0D,0x14}},
	{0xC6,10,{0x87,0xA2,0x24,0x22,0x22,0x31,0x7F,0x04,0x08,0x00}},
	// {0xC7,22,{0xFA,0xCF,0xAF,0x99,0x6D,0x4E,0x1C,0x6D,0x32,0x02,0xD6,0xA3,0xF9,0xCB,0xAB,0x84,0x70,0x49,0x1A,0x7F,0xE0,0x00}},
	// {0xC8,22,{0xFA,0xCF,0xAF,0x99,0x6D,0x4E,0x1C,0x6D,0x32,0x02,0xD6,0xA3,0xF9,0xCB,0xAB,0x84,0x70,0x49,0x1A,0x7F,0xE0,0x00}},
	{0xC7,22,{0xFA,0xCF,0xB0,0x98,0x6C,0x4C,0x1A,0x6B,0x31,0x02,0xD6,0xA2,0xF9,0xCC,0xAD,0x84,0x6B,0x49,0x1A,0x7F,0xE0,0x00}},
	{0xC8,22,{0xFA,0xCF,0xB0,0x98,0x6C,0x4C,0x1A,0x6B,0x31,0x02,0xD6,0xA2,0xF9,0xCC,0xAD,0x84,0x6B,0x49,0x1A,0x7F,0xE0,0x00}},
	{0xE5,22,{0x03,0x7C,0x2E,0xA9,0xAA,0xFC,0x00,0x00,0xCF,0xC6,0x00,0x52,0xFC,0x00,0x00,0x0E,0xAF,0x58,0xFC,0xAB,0xFF,0xC0}},
	{0xE6,26,{0xF7,0xF6,0xF4,0xF3,0xF1,0xED,0xE9,0xE2,0xDA,0xCB,0xBC,0x9E,0x7F,0x7E,0x5E,0x3E,0x2E,0x1E,0x16,0x0F,0x0B,0x07,0x05,0x03,0x01,0x00}},
	{0xE7,26,{0xFF,0xFE,0xFB,0xF9,0xF7,0xF4,0xEF,0xE7,0xDF,0xCF,0xBF,0x9F,0x7F,0x7E,0x5E,0x3E,0x2E,0x1E,0x16,0x0F,0x0B,0x07,0x05,0x03,0x01,0x00}},
	{0xE8,26,{0xFE,0xFD,0xFA,0xF8,0xF6,0xF2,0xED,0xE5,0xDD,0xCD,0xBD,0x9E,0x7E,0x7D,0x5D,0x3E,0x2E,0x1E,0x16,0x0E,0x0A,0x06,0x04,0x02,0x00,0x00}},
	{0xCB, 1,{0x00}},
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	if (rf_hw_id == 1) {
		...
		LCM_INFO("%s %s rf_hw_id PLL_CLOCK %d\n", __func__, LOG_PROJ_NAME, params->dsi.PLL_CLOCK);
	}
#endif
...
static void lcm_suspend_power(void)
{
	if (phone_shutdown_state) {
		LCM_INFO("[LCM] %s %s lcm_suspend_power reset keep low level\n", LOG_PROJ_NAME, LOG_PANEL_TYPE);
		lcm_reset_setting(0);
	}
	MDELAY(10);
	lcm_enn_setting(0);
	...
	lcm_enp_setting(0);
	MDELAY(5);
	LCM_INFO("[LCM] %s %s lcm_suspend_power - vddi keep high level\n", LOG_PROJ_NAME, LOG_PANEL_TYPE);
	panel_reset_state = 0;// clear reset state
}

static void lcm_init(void)
{
	LCM_INFO("[LCM] %s %s - init begin\n", LOG_PROJ_NAME, LOG_PANEL_TYPE);
	lcm_reset_setting(1);
	MDELAY(20);
	lcm_reset_setting(0);
	MDELAY(12);
...
static void lcm_suspend(void)
{
	push_table(lcm_suspend_setting,
		...
		1);
	panel_off_state = 1;
	LCM_INFO("[LCM] %s %s - lcm_suspend display off\n", LOG_PROJ_NAME, LOG_PANEL_TYPE);
}

static void lcm_resume(void)
{
	LCM_INFO("[LCM] %s %s :resume\n", LOG_PROJ_NAME, LOG_PANEL_TYPE);
	lcm_init();
}
...
static void lcm_reset_for_touch(void)
{
	...
	MDELAY(53);
	panel_reset_state = 1;
	LCM_INFO("[LCM] %s %s - lcm_reset_for_touch end\n", LOG_PROJ_NAME, LOG_PANEL_TYPE);
}
...
static unsigned int lcm_esd_check(void)
{
	...
	if (buffer[0] != 0x9c) {
		LCM_INFO("[LCM][%s %s LCM ERROR] [0x53]=0x%02x\n", LOG_PROJ_NAME, LOG_PANEL_TYPE, buffer[0]);
		return TRUE;
	}
	LCM_INFO("[LCM][%s %s LCM NORMAL] [0x53]=0x%02x\n", LOG_PROJ_NAME, LOG_PANEL_TYPE, buffer[0]);
	return FALSE;
#else
	return FALSE;
#endif
...
static unsigned int lcm_ata_check(unsigned char *buffer)
{
	...
	LCM_INFO("[LCM] %s %s ATA check size = 0x%x, 0x%x, 0x%x, 0x%x\n",
		 LOG_PROJ_NAME, LOG_PANEL_TYPE, x0_MSB, x0_LSB, x1_MSB, x1_LSB);
...
struct LCM_DRIVER pd2216_lce_icnl9911c_noflash_hdp_dsi_vdo_lcm_drv = {
	.name = "pd2216_lce_icnl9911c_noflash_hdp_dsi_vdo",
