...
enum tcpc_cc_pull_state {
	TYPEC_CC_PULL_BOTH = 0,
	TYPEC_CC_PULL_CC1 = 0x20,
	TYPEC_CC_PULL_CC2 = 0x60,
	TYPEC_CC_PULL_RESERVED = 3,
};
...
enum tcpc_cc_pull {
	...
	TYPEC_CC_RP_CC1_DFT = TYPEC_CC_PULL_CC1 | TYPEC_CC_RP_DFT,
	TYPEC_CC_RP_CC1_1_5 = TYPEC_CC_PULL_CC1 | TYPEC_CC_RP_1_5,
	TYPEC_CC_RP_CC1_3_0 = TYPEC_CC_PULL_CC1 | TYPEC_CC_RP_3_0,
	TYPEC_CC_RP_CC2_DFT = TYPEC_CC_PULL_CC2 | TYPEC_CC_RP_DFT,
	TYPEC_CC_RP_CC2_1_5 = TYPEC_CC_PULL_CC2 | TYPEC_CC_RP_1_5,
	TYPEC_CC_RP_CC2_3_0 = TYPEC_CC_PULL_CC2 | TYPEC_CC_RP_3_0,
};

#define TYPEC_CC_PULL_GET_RES(pull)	(pull & 0x07)
#define TYPEC_CC_PULL_GET_RP_LVL(pull)	((pull & 0x18) >> 3)
#define TYPEC_CC_PULL_GET_CC_STATE(pull)	(pull & 0x60)
...
struct tcpc_ops {
	...
	int (*is_reg_default)(struct tcpc_device *tcpc);
