...
{
    LCM_INFO("report_lcm_id project_name=%s, lcm_id_version=%d\n", project_name, lcm_id_version);

	if (!strcmp(project_name, "PD2036") || !strcmp(project_name, "PD2036F_EX")) {
	if (lcm_id_version == 0x7C)
		...
		return 0xFF;
	} else if (!strcmp(project_name, "PD1987") || !strcmp(project_name, "PD1987F_EX"))  {
	...
	if (lcm_id_version == 0x60 || lcm_id_version == 0x7E)/*pd1901 TM ft8006P*/
		return 0x15;
	else if (lcm_id_version == 0x61)/*pd1901 BOE NT36525*/
		return 0x3A;
	else if (lcm_id_version == 0x62)/*pd1901 lianchuang NT36525*/
		return 0x51;
	else if (lcm_id_version == 0x63)/*pd1901 AUO FT8006P,There's no AUO NT36525*/
		return 0x40;
	else if (lcm_id_version == 0x64)/*pd1901 qunchuang NT36525*/
		return 0x61;
	else if (lcm_id_version == 0x6d)/*pd1901 BOE NT36525B 20190322 add*/
		return 0x3B;
	else if (lcm_id_version == 0x74)/*pd1901 BOE FT8006P 20190505 add*/
		return 0x3C;
	else if (lcm_id_version == 0x75)
		return 0x62;
	else if (lcm_id_version == 0x78)/*pd1901 lianchuang FT8006P 20190606 lrz add*/
		return 0x50;
	else if (lcm_id_version == 0x6f)
		return 0x52;
	else if (lcm_id_version == 0x70)/*pd1901 lianchuang FT8006P 20190606 lrz add*/
		return 0x41;
	else
		return 0x15;/*PD1901 ,most LCM use FT8006p*/
	}else if (!strcmp(project_name, "PD2139F_EX") || !strcmp(project_name, "PD2139JF_EX"))  {
	...
	if	(lcm_id_version == 0x7C)
		...
		return 0xFF;
	} else if (!strcmp(project_name, "PD2140IF_EX") || !strcmp(project_name, "PD2140JF_EX")) {
	if	(lcm_id_version == 0x7C)
		return 0x31;
	else if (lcm_id_version == 0x45)
		return 0x13;
		...
		return 0xFF;
	}else if (!strcmp(project_name, "PD2140NF_EX")){
		if	(lcm_id_version == 0x7C)
		return 0x31;
	else if (lcm_id_version == 0x45)
		return 0x13;
	...
	if (lcm_id_version == 0x23)
		...
		return 0x34;
	else if (lcm_id_version == 0x05)
		return 0xB3;
	else if (lcm_id_version == 0x27)
		return 0x62;
	else if (lcm_id_version == 0x10)
		return 0xB5;
...
int primary_display_resume(void)
{
	...
	if (lcm_drv->lcm_reset) {
		...
		if (!strcmp(project_name, "PD1987") || !strcmp(project_name, "PD2014")) {
			lcm_drv->lcm_reset();
		} else if ((!strcmp(project_name, "PD2036F_EX")) || (!strcmp(project_name, "PD2139F_EX")) || (!strcmp(project_name, "PD2140F_EX")) ||
						(!strcmp(project_name, "PD2140")) || (!strcmp(project_name, "PD2140IF_EX")) ||
						(!strcmp(project_name, "PD2140JF_EX")) || (!strcmp(project_name, "PD2213F_EX"))) {
			if (lcm_id == 0x31 || lcm_id == 0xA1 || lcm_id == 0xB1) {
				DISPINFO("pd2036f_ex nt36525b need reset keep high befor LP11\n");
				lcm_drv->lcm_reset();
			}
		} else if (!strcmp(project_name, "PD2140NF_EX")) {
			if (lcm_id == 0x30 || lcm_id == 0xA1 || lcm_id == 0xB1) {
				DISPINFO("pd140NF nt36525b need reset keep high befor LP11\n");
				lcm_drv->lcm_reset();
			}
		} else if (!strcmp(project_name, "PD2236F_EX") || !strcmp(project_name, "PD2236DF_EX") || !strcmp(project_name, "PD2236IF_EX")) {
			if (lcm_id == 0x31){
				DISPINFO("PD2236F_EX ILI9883c need reset keep high befor LP11\n");
				lcm_drv->lcm_reset();
			}

		}
		else if (lcm_id != 0x62 && lcm_id != 0x3C && lcm_id != 0x40 && lcm_id != 0x50 && lcm_id != 0x15  && lcm_id != 0x01 &&
					lcm_id != 0x02 && lcm_id != 0x20 && lcm_id != 0x21 && lcm_id != 0x14 && lcm_id != 0x22 && lcm_id != 0x11 &&
					lcm_id != 0x00 && lcm_id != 0x35 && lcm_id != 0x90 && lcm_id != 0xB3 && lcm_id != 0x10 && lcm_id != 0x28) {
			lcm_drv->lcm_reset();
		} else {
...
int primary_display_setbacklight(unsigned int level)
{
	...
	/*myx add for close cabc when backlight < 768*/
	if (!strcmp(project_name, "PD2036F_EX") || !strcmp(project_name, "PD2074F_EX") || !strcmp(project_name, "PD1987") || !strcmp(project_name, "PD1987F_EX") || !strcmp(project_name, "PD2014") || !strcmp(project_name, "PD2014F_EX")|| !strcmp(project_name, "PD2139F_EX")) {
		if (lcm_low_backlight_cabc_status && lcm_cabc_status && level < 788) {
			primary_display_setvivocabc_close_unlock(0);
			lcm_low_backlight_cabc_status=0;
			LCM_INFO("disp lcm close cabc  when backlight low\n");
		}

		if (!lcm_low_backlight_cabc_status && lcm_cabc_status && level >= 788) {
			primary_display_setvivocabc_open_unlock(0x2c, lcm_cabc_status);
			lcm_low_backlight_cabc_status=1;
			LCM_INFO("disp lcm restore cabc when backlight > 788\n");
		}
	}

  	if (!strcmp(project_name, "PD1901")) {
		if (lcm_low_backlight_cabc_status && lcm_cabc_status && level < 1524) {
			primary_display_setvivocabc_close_unlock(0);
			lcm_low_backlight_cabc_status=0;
			LCM_INFO("disp lcm close cabc  when backlight low\n");
		}
		...
		if (!lcm_low_backlight_cabc_status && lcm_cabc_status && level >= 1524) {
			primary_display_setvivocabc_open_unlock(0x2c, lcm_cabc_status);
			lcm_low_backlight_cabc_status=1;
			LCM_INFO("disp lcm restore cabc when backlight > 1524\n");
		}
	}

	if (!strcmp(project_name, "PD2036F_EX") || !strcmp(project_name, "PD2074F_EX") || !strcmp(project_name, "PD1987") || !strcmp(project_name, "PD1987F_EX") || !strcmp(project_name, "PD1901") || !strcmp(project_name, "PD2014") || !strcmp(project_name, "PD2014F_EX") || !strcmp(project_name, "PD2139F_EX") || !strcmp(project_name, "PD2140F_EX") ) {
		if (level == 0) {
			pre_cabc_level = 0;
			lcm_cabc_status = 0;
		}
						...
						struct device_attribute *attr, const char *buf, size_t count)
{
	...
	}else if (lcm_cabc_status && (vivo_lcm_cabc_backlight < 788) && (!strcmp(project_name, "PD2139F_EX"))) {
		LCM_INFO("current level is %d ,less than %d , dont set CABC\n", vivo_lcm_cabc_backlight, 788);
...
/* vivo LCM add for lcm_panel_info begin 2021/7/7 */
static ssize_t get_lcm_info(struct device *dev,
                       struct device_attribute *attr, char *buf)
{
	char *lcm_info = NULL;
	switch (lcm_id_version) {
	case 0x7C:
		lcm_info = "boe_nt36525b_noflash_hdp_dsi_vdo";
		LCM_INFO("[get_lcm_info]: lcm_info: %s\n", lcm_info);
		break;
	case 0x45:
		lcm_info = "tianma_ili9881h_noflash_hdp_dsi_vdo";
		LCM_INFO("[get_lcm_info]: lcm_info: %s\n", lcm_info);
		break;
	case 0x57:
		lcm_info = "boe_icnl9911c_noflash_hdp_dsi_vdo";
		LCM_INFO("[get_lcm_info]: lcm_info: %s\n", lcm_info);
		break;
	case 0x56:
		lcm_info = "hx_ft8656_noflash_hdp_dsi_vdo";
		LCM_INFO("[get_lcm_info]: lcm_info: %s\n", lcm_info);
		break;
	case 0x43:
		lcm_info = "txd_nt36525a_noflash_hdp_dsi_vdo";
		LCM_INFO("[get_lcm_info]: lcm_info: %s\n", lcm_info);
		break;
	case 0x11:
		lcm_info = "lce_ft8016_noflash_hdp_dsi_vdo";
		LCM_INFO("[get_lcm_info]: lcm_info: %s\n", lcm_info);
		break;
	/*PD2236*/
	case 0x68:
		lcm_info = "txd_jd9365t_hdplus_dsi_vdo";
		LCM_INFO("[get_lcm_info]: lcm_info: %s\n", lcm_info);
		break;
	case 0x20:
		lcm_info = "ski651_icnl9911c_noflash_hdp_dsi_vdo";
		LCM_INFO("[get_lcm_info]: lcm_info: %s\n", lcm_info);
		break;
	case 0x30:
		lcm_info = "tianma_ili9883c_hdplus_dsi_vdo";
		LCM_INFO("[get_lcm_info]: lcm_info: %s\n", lcm_info);
		break;
	case 0x27:
		lcm_info = "tianma_icnl9911c_noflash_hdp_dsi_vdo";
		LCM_INFO("[get_lcm_info]: lcm_info: %s\n", lcm_info);
		break;
	default:
		DISPERR("[get_lcm_info]: no find lcm_id_version\n");
	}
	return scnprintf(buf, PAGE_SIZE, "%s\n", lcm_info);
}
/* vivo LCM add for lcm_panel_info end */
...
static DEVICE_ATTR(lcm_panel_info, 0444, get_lcm_info, NULL);
