...
static int __parse_tag_videolfb(struct device_node *node)
{
	...
	if (!strcmp(project_name, "PD1987") || !strcmp(project_name, "PD1987F_EX")) {
			if (!strcmp(mtkfb_lcm_name, "pd1987_boe_nt36525b_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd1987_qunchuang_ili9881h_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd1987_lianchuang_nt36525b_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd1987_dijing_nt36525b_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd1987_tianma_ili9881h_noflash_hdp_dsi_vdo"))
				DISPERR("[DT][videolfb] mtkfb lcm name match succed\n");
			else {
				memset((void *)mtkfb_lcm_name, 0, sizeof(mtkfb_lcm_name));
				lcm_id_version = videolfb_tag->lcm_id;
				if (lcm_id_version == 0x61) {
					strncpy((char *)mtkfb_lcm_name, "pd1987_boe_nt36525b_noflash_hdp_dsi_vdo",
						sizeof("pd1987_boe_nt36525b_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd1987_boe_nt36525b_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x62) {
				strncpy((char *)mtkfb_lcm_name, "pd1987_qunchuang_ili9881h_noflash_hdp_dsi_vdo",
					sizeof("pd1987_qunchuang_ili9881h_noflash_hdp_dsi_vdo"));
				mtkfb_lcm_name[strlen("pd1987_lianchuang_ft8006p_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x65) {
					strncpy((char *)mtkfb_lcm_name, "pd1987_lianchuang_nt36525b_noflash_hdp_dsi_vdo",
						sizeof("pd1987_lianchuang_nt36525b_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd1987_lianchuang_nt36525b_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x63) {
					strncpy((char *)mtkfb_lcm_name, "pd1987_dijing_nt36525b_noflash_hdp_dsi_vdo",
						sizeof("pd1987_dijing_nt36525b_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd1987_dijing_nt36525b_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x66) {
				strncpy((char *)mtkfb_lcm_name, "pd1987_tianma_ili9881h_noflash_hdp_dsi_vdo",
					sizeof("pd1987_tianma_ili9881h_noflash_hdp_dsi_vdo"));
				mtkfb_lcm_name[strlen("pd1987_tianma_ft8006p_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x4a) {
					strncpy((char *)mtkfb_lcm_name, "pd1987_lianchuang_nt36525b_noflash_hdp_dsi_vdo",
						sizeof("pd1987_lianchuang_nt36525b_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd1987_lianchuang_nt36525b_noflash_hdp_dsi_vdo")] = '\0';
				}
			}
		} else if (!strcmp(project_name, "PD2036F_EX") || !strcmp(project_name, "PD2036")) {
			if (!strcmp(mtkfb_lcm_name, "pd2036_boe_nt36525b_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2036_tianma_ili9881h_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2036_txd_nt36525b_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2036_inx_nt36525b_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2036_inx_ili9882n_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2036_txd_ft8016_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2036_txd_nt36525a_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2036_boe_icnl9911_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2036_inx_ili9882q_noflash_hdp_dsi_vdo"))
				DISPERR("[DT][videolfb] PD2036 mtkfb lcm name match succed\n");
			else {
				memset((void *)mtkfb_lcm_name, 0, sizeof(mtkfb_lcm_name));
				lcm_id_version = videolfb_tag->lcm_id;
				if (lcm_id_version == 0x7C) {
				...
				} else if (lcm_id_version == 0x7D) {
					strncpy((char *)mtkfb_lcm_name, "pd2036_tianma_ili9881h_noflash_hdp_dsi_vdo",
						sizeof("pd2036_tianma_ili9881h_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2036_tianma_ili9881h_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x40) {
					strncpy((char *)mtkfb_lcm_name, "pd2036_txd_nt36525b_noflash_hdp_dsi_vdo",
						sizeof("pd2036_txd_nt36525b_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2036_txd_nt36525b_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x7E) {
					strncpy((char *)mtkfb_lcm_name, "pd2036_inx_nt36525b_noflash_hdp_dsi_vdo",
						sizeof("pd2036_inx_nt36525b_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2036_inx_nt36525b_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x4B) {
					strncpy((char *)mtkfb_lcm_name, "pd2036_inx_nt36525b_noflash_hdp_dsi_vdo",
						sizeof("pd2036_inx_nt36525b_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2036_inx_nt36525b_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x54) {
					strncpy((char *)mtkfb_lcm_name, "pd2036_inx_ili9882n_noflash_hdp_dsi_vdo",
						sizeof("pd2036_inx_ili9882n_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2036_inx_ili9882n_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x4F) {
					strncpy((char *)mtkfb_lcm_name, "pd2036_tianma_ili9882n_noflash_hdp_dsi_vdo",
						sizeof("pd2036_tianma_ili9882n_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2036_tianma_ili9882n_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x46) {
					strncpy((char *)mtkfb_lcm_name, "pd2036_txd_ft8016_noflash_hdp_dsi_vdo",
						sizeof("pd2036_txd_ft8016_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2036_txd_ft8016_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x43) {
					strncpy((char *)mtkfb_lcm_name, "pd2036_txd_nt36525a_noflash_hdp_dsi_vdo",
						sizeof("pd2036_txd_nt36525a_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2036_txd_nt36525a_noflash_hdp_dsi_vdo")] = '\0';
				}else if (lcm_id_version == 0x57) {
					strncpy((char *)mtkfb_lcm_name, "pd2036_boe_icnl9911_noflash_hdp_dsi_vdo",
						sizeof("pd2036_boe_icnl9911_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2036_boe_icnl9911_noflash_hdp_dsi_vdo")] = '\0';
				}else if (lcm_id_version == 0x55) {
		 	...
		 	}else if (!strcmp(project_name, "PD2074F_EX")) {
		 	if (!strcmp(mtkfb_lcm_name, "pd2074_boe_nt36525b_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2074_tianma_ili9882n_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2074_inx_ili9882n_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2074_txd_ft8016_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2074_txd_nt36525a_noflash_hdp_dsi_vdo"))
				DISPERR("[DT][videolfb] PD2074 mtkfb lcm name match succed\n");
			else {
				memset((void *)mtkfb_lcm_name, 0, sizeof(mtkfb_lcm_name));
				lcm_id_version = videolfb_tag->lcm_id;
				if (lcm_id_version == 0x7C) {
					strncpy((char *)mtkfb_lcm_name, "pd2074_boe_nt36525b_noflash_hdp_dsi_vdo",
						sizeof("pd2074_boe_nt36525b_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2074_boe_nt36525b_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x54) {
					strncpy((char *)mtkfb_lcm_name, "pd2074_inx_ili9882n_noflash_hdp_dsi_vdo",
						sizeof("pd2074_inx_ili9882n_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2074_inx_ili9882n_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x4F) {
					strncpy((char *)mtkfb_lcm_name, "pd2074_tianma_ili9882n_noflash_hdp_dsi_vdo",
						sizeof("pd2074_tianma_ili9882n_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2074_tianma_ili9882n_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x46) {
					strncpy((char *)mtkfb_lcm_name, "pd2074_txd_ft8016_noflash_hdp_dsi_vdo",
						sizeof("pd2074_txd_ft8016_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2074_txd_ft8016_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x43) {
					strncpy((char *)mtkfb_lcm_name, "pd2074_txd_nt36525a_noflash_hdp_dsi_vdo",
						sizeof("pd2074_txd_nt36525a_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2074_txd_nt36525a_noflash_hdp_dsi_vdo")] = '\0';
				}
			}

			} else if (!strcmp(project_name, "PD1901")) {
			if (!strcmp(mtkfb_lcm_name, "pd1901_tianma_ft8006p_noflash_hdp_dsi_vdo")
				|| !strcmp(mtkfb_lcm_name, "pd1901_boe_nt36525_noflash_hdp_dsi_vdo")
				|| !strcmp(mtkfb_lcm_name, "pd1901_qunchuang_nt36525_noflash_hdp_dsi_vdo")
				|| !strcmp(mtkfb_lcm_name, "pd1901_boe_nt36525b_noflash_hdp_dsi_vdo")
				|| !strcmp(mtkfb_lcm_name, "pd1901_auo2_nt36525b_noflash_hdp_dsi_vdo")
				|| !strcmp(mtkfb_lcm_name, "pd1901_lianchuang2_nt36525b_noflash_hdp_dsi_vdo")
				|| !strcmp(mtkfb_lcm_name, "pd1901_qunchuang_nt36525b_noflash_hdp_dsi_vdo")
				|| !strcmp(mtkfb_lcm_name, "pd1901_lianchuang_nt36525_noflash_hdp_dsi_vdo")
				|| !strcmp(mtkfb_lcm_name, "pd1901_boe_ft8006p_noflash_hdp_dsi_vdo")
				|| !strcmp(mtkfb_lcm_name, "pd1901_auo_ft8006p_noflash_hdp_dsi_vdo")
				|| !strcmp(mtkfb_lcm_name, "pd1901_qunchuang_ili9881h_noflash_hdp_dsi_vdo")
				|| !strcmp(mtkfb_lcm_name, "pd1901_lianchuang_ft8006p_noflash_hdp_dsi_vdo"))
				DISPERR("[DT][videolfb] mtkfb lcm name match succed\n");
			else {
				memset((void *)mtkfb_lcm_name, 0, sizeof(mtkfb_lcm_name));
				lcm_id_version = videolfb_tag->lcm_id;
				if (lcm_id_version == 0x60) {
					strncpy((char *)mtkfb_lcm_name, "pd1901_tianma_ft8006p_noflash_hdp_dsi_vdo",
						sizeof("pd1901_tianma_ft8006p_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd1901_tianma_ft8006p_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x61) {
					strncpy((char *)mtkfb_lcm_name, "pd1901_boe_nt36525_noflash_hdp_dsi_vdo",
						sizeof("pd1901_boe_nt36525_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd1901_boe_nt36525_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x62) {
				strncpy((char *)mtkfb_lcm_name, "pd1901_lianchuang_nt36525_noflash_hdp_dsi_vdo",
					sizeof("pd1901_lianchuang_nt36525_noflash_hdp_dsi_vdo"));
				mtkfb_lcm_name[strlen("pd1901_lianchuang_nt36525_noflash_hdp_dsi_vdo")] = '\0';
				}
				else if (lcm_id_version == 0x64) {
				strncpy((char *)mtkfb_lcm_name, "pd1901_qunchuang_nt36525_noflash_hdp_dsi_vdo",
					sizeof("pd1901_qunchuang_nt36525_noflash_hdp_dsi_vdo"));
				mtkfb_lcm_name[strlen("pd1901_qunchuang_nt36525_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x6d) {
				strncpy((char *)mtkfb_lcm_name, "pd1901_boe_nt36525b_noflash_hdp_dsi_vdo",
					sizeof("pd1901_boe_nt36525b_noflash_hdp_dsi_vdo"));
				mtkfb_lcm_name[strlen("pd1901_boe_nt36525b_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x74) {
				strncpy((char *)mtkfb_lcm_name, "pd1901_boe_ft8006p_noflash_hdp_dsi_vdo",
					sizeof("pd1901_boe_ft8006p_noflash_hdp_dsi_vdo"));
				mtkfb_lcm_name[strlen("pd1901_boe_ft8006p_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x63) {
				strncpy((char *)mtkfb_lcm_name, "pd1901_auo_ft8006p_noflash_hdp_dsi_vdo",
					sizeof("pd1901_auo_ft8006p_noflash_hdp_dsi_vdo"));
				mtkfb_lcm_name[strlen("pd1901_auo_ft8006p_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x75) {
				strncpy((char *)mtkfb_lcm_name, "pd1901_qunchuang_ili9881h_noflash_hdp_dsi_vdo",
					sizeof("pd1901_qunchuang_ili9881h_noflash_hdp_dsi_vdo"));
				mtkfb_lcm_name[strlen("pd1901_qunchuang_ili9881h_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x78) {
				strncpy((char *)mtkfb_lcm_name, "pd1901_lianchuang_ft8006p_noflash_hdp_dsi_vdo",
					sizeof("pd1901_lianchuang_ft8006p_noflash_hdp_dsi_vdo"));
				mtkfb_lcm_name[strlen("pd1901_lianchuang_ft8006p_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x6f) {
				strncpy((char *)mtkfb_lcm_name, "pd1901_lianchuang2_nt36525b_noflash_hdp_dsi_vdo",
					sizeof("pd1901_lianchuang2_nt36525b_noflash_hdp_dsi_vdo"));
				mtkfb_lcm_name[strlen("pd1901_lianchuang2_nt36525b_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x70) {
				strncpy((char *)mtkfb_lcm_name, "pd1901_auo2_nt36525b_noflash_hdp_dsi_vdo",
					sizeof("pd1901_auo2_nt36525b_noflash_hdp_dsi_vdo"));
				mtkfb_lcm_name[strlen("pd1901_auo2_nt36525b_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0xff) {
				strncpy((char *)mtkfb_lcm_name, "pd1901_qunchuang_nt36525b_noflash_hdp_dsi_vdo",
					sizeof("pd1901_qunchuang_nt36525b_noflash_hdp_dsi_vdo"));
				mtkfb_lcm_name[strlen("pd1901_qunchuang_nt36525b_noflash_hdp_dsi_vdo")] = '\0';
				}
			}
		}else if (!strcmp(project_name, "PD2139F_EX")) {
			if (!strcmp(mtkfb_lcm_name, "pd2036_boe_nt36525b_noflash_hdp_dsi_vdo")||
				!strcmp(mtkfb_lcm_name, "pd2139_txd_ft8016_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2036_txd_ft8016_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2036_inx_ili9882q_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2139_boe_nt36525b_v1_noflash_hdp_dsi_vdo"))
				...
				if (lcm_id_version == 0x07) {
					...
					strncpy((char *)mtkfb_lcm_name, "pd2139_txd_ft8016_noflash_hdp_dsi_vdo",
						sizeof("pd2139_txd_ft8016_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2139_txd_ft8016_noflash_hdp_dsi_vdo")] = '\0';
					...
					strncpy((char *)mtkfb_lcm_name, "pd2139_boe_nt36525b_v1_noflash_hdp_dsi_vdo",
						sizeof("pd2139_boe_nt36525b_v1_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2139_boe_nt36525b_v1_noflash_hdp_dsi_vdo")] = '\0';
				}
			}
		} else if (!strcmp(project_name, "PD2140F_EX")) {
		 	if (!strcmp(mtkfb_lcm_name, "pd2140_boe_nt36525b_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2140_tianma_ili9881h_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2140_boe_icnl9911c_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2140_hx_ft8656_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2140_txd_nt36525a_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2140_lce_ft8016_noflash_hdp_dsi_vdo"))
				DISPERR("[DT][videolfb] PD2140 mtkfb lcm name match succed\n");
			else {
				memset((void *)mtkfb_lcm_name, 0, sizeof(mtkfb_lcm_name));
				lcm_id_version = videolfb_tag->lcm_id;
				if (lcm_id_version == 0x7C) {
					strncpy((char *)mtkfb_lcm_name, "pd2140_boe_nt36525b_noflash_hdp_dsi_vdo",
						sizeof("pd2140_boe_nt36525b_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2140_boe_nt36525b_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x45) {
					strncpy((char *)mtkfb_lcm_name, "pd2140_tianma_ili9881h_noflash_hdp_dsi_vdo",
						sizeof("pd2140_tianma_ili9881h_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2140_tianma_ili9881h_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x57) {
					strncpy((char *)mtkfb_lcm_name, "pd2140_boe_icnl9911c_noflash_hdp_dsi_vdo",
						sizeof("pd2140_boe_icnl9911c_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2140_boe_icnl9911c_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x56) {
					strncpy((char *)mtkfb_lcm_name, "pd2140_hx_ft8656_noflash_hdp_dsi_vdo",
						sizeof("pd2140_hx_ft8656_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2140_hx_ft8656_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x43) {
					strncpy((char *)mtkfb_lcm_name, "pd2140_txd_nt36525a_noflash_hdp_dsi_vdo",
						sizeof("pd2140_txd_nt36525a_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2140_txd_nt36525a_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x11) {
					strncpy((char *)mtkfb_lcm_name, "pd2140_lce_ft8016_noflash_hdp_dsi_vdo",
						sizeof("pd2140_lce_ft8016_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2140_lce_ft8016_noflash_hdp_dsi_vdo")] = '\0';
				}
			}
		} else if (!strcmp(project_name, "PD2140")) {
		 	if (!strcmp(mtkfb_lcm_name, "pd2140_boe_nt36525b_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2140_tianma_ili9881h_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2140_boe_icnl9911c_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2140_hx_ft8656_noflash_hdp_dsi_vdo") ||
		...
		} else if (!strcmp(project_name, "PD2140IF_EX") || !strcmp(project_name, "PD2140JF_EX") || !strcmp(project_name, "PD2140NF_EX")) {
		 	if (!strcmp(mtkfb_lcm_name, "pd2140_boe_nt36525b_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2140_tianma_ili9881h_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2140_boe_icnl9911c_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2140_hx_ft8656_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2140_txd_nt36525a_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2140_lce_ft8016_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2140jf_boe_nt36525b_noflash_hdp_dsi_vdo"))
				DISPERR("[DT][videolfb] mtkfb[%s] lcm name match succed\n", project_name);
			else {
				memset((void *)mtkfb_lcm_name, 0, sizeof(mtkfb_lcm_name));
				lcm_id_version = videolfb_tag->lcm_id;
				if (lcm_id_version == 0x7C) {
					...
					if (!strcmp(project_name, "PD2140NF_EX")) {
						strncpy((char *)mtkfb_lcm_name, "pd2140nf_boe_6m_nt36525b_hdplus_dsi_vdo",
							sizeof("pd2140nf_boe_6m_nt36525b_hdplus_dsi_vdo"));
						mtkfb_lcm_name[strlen("pd2140nf_boe_6m_nt36525b_hdplus_dsi_vdo")] = '\0';
					}
					else {
						strncpy((char *)mtkfb_lcm_name, "pd2140jf_boe_nt36525b_noflash_hdp_dsi_vdo",
							sizeof("pd2140jf_boe_nt36525b_noflash_hdp_dsi_vdo"));
						mtkfb_lcm_name[strlen("pd2140jf_boe_nt36525b_noflash_hdp_dsi_vdo")] = '\0';
					}
				}
			}
		}else if (!strcmp(project_name, "PD2216F_EX") || !strcmp(project_name, "PD2216JF_EX")){
			if (!strcmp(mtkfb_lcm_name, "pd2216_txd_ft8016_hdplus_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2216_holitech_jd9365t_hdplus_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2216_boe_nt36525b_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2216_lce_icnl9911c_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2216_tianma_icnl9911c_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2216_hx_ft8656_noflash_hdp_dsi_vdo"))
				DISPERR("[DT][videolfb] mtkfb[%s] lcm name match succed\n", project_name);
			else{
				memset((void *)mtkfb_lcm_name, 0, sizeof(mtkfb_lcm_name));
				lcm_id_version = videolfb_tag->lcm_id;
				if (lcm_id_version == 0x23) {
					strncpy((char *)mtkfb_lcm_name, "pd2216_txd_ft8016_hdplus_dsi_vdo",
						sizeof("pd2216_txd_ft8016_hdplus_dsi_vdo"));
				} else if (lcm_id_version == 0x93) {
					strncpy((char *)mtkfb_lcm_name, "pd2216_holitech_jd9365t_hdplus_dsi_vdo",
						sizeof("pd2216_holitech_jd9365t_hdplus_dsi_vdo"));
				} else if (lcm_id_version == 0x0F) {
					strncpy((char *)mtkfb_lcm_name, "pd2216_boe_nt36525b_hdp_dsi_vdo",
						sizeof("pd2216_boe_nt36525b_hdp_dsi_vdo"));
				} else if (lcm_id_version == 0x5) {
					strncpy((char *)mtkfb_lcm_name, "pd2216_lce_icnl9911c_noflash_hdp_dsi_vdo",
						sizeof("pd2216_lce_icnl9911c_noflash_hdp_dsi_vdo"));
				} else if (lcm_id_version == 0x27) {
					strncpy((char *)mtkfb_lcm_name, "pd2216_tianma_icnl9911c_noflash_hdp_dsi_vdo",
						sizeof("pd2216_tianma_icnl9911c_noflash_hdp_dsi_vdo"));
				} else if (lcm_id_version == 0x28) {
					strncpy((char *)mtkfb_lcm_name, "pd2216_truly_ili9882q_hdplus_dsi_vdo",
						sizeof("pd2216_truly_ili9882q_hdplus_dsi_vdo"));
				} else if (lcm_id_version == 0x56) {
					strncpy((char *)mtkfb_lcm_name, "pd2216_hx_ft8656_noflash_hdp_dsi_vdo",
						sizeof("pd2216_hx_ft8656_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2216_hx_ft8656_noflash_hdp_dsi_vdo")] = '\0';
				mtkfb_lcm_name[strlen(mtkfb_lcm_name)] = '\0';
				}
			}
		} else if (!strcmp(project_name, "PD2213F_EX")) {
		 	if (!strcmp(mtkfb_lcm_name, "pd2213_boe_icnl9911c_noflash_hdp_dsi_vdo") ||
				!strcmp(mtkfb_lcm_name, "pd2140_boe_nt36525b_noflash_hdp_dsi_vdo"))
				DISPERR("[DT][videolfb] PD2213 mtkfb lcm name match succed\n");
			else {
				memset((void *)mtkfb_lcm_name, 0, sizeof(mtkfb_lcm_name));
				lcm_id_version = videolfb_tag->lcm_id;
				if (lcm_id_version == 0x57) {
					strncpy((char *)mtkfb_lcm_name, "pd2213_boe_icnl9911c_noflash_hdp_dsi_vdo",
						sizeof("pd2213_boe_icnl9911c_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2213_boe_icnl9911c_noflash_hdp_dsi_vdo")] = '\0';
				} else if (lcm_id_version == 0x7C) {
					strncpy((char *)mtkfb_lcm_name, "pd2140_boe_nt36525b_noflash_hdp_dsi_vdo",
						sizeof("pd2140_boe_nt36525b_noflash_hdp_dsi_vdo"));
					mtkfb_lcm_name[strlen("pd2140_boe_nt36525b_noflash_hdp_dsi_vdo")] = '\0';
				}
			}
		} else if (!strcmp(project_name, "PD2236F_EX") || !strcmp(project_name, "PD2236DF_EX") || !strcmp(project_name, "PD2236IF_EX") || !strcmp(project_name, "PD2236")) {
			if (!strcmp(mtkfb_lcm_name, "pd2236_txd_jd9365t_hdplus_dsi_vdo") ||
			    !strcmp(mtkfb_lcm_name, "pd2236_ski651_icnl9911c_noflash_hdp_dsi_vdo") ||
			    !strcmp(mtkfb_lcm_name, "pd2236_tianma_ili9883c_hdplus_dsi_vdo"))
				DISPERR("[DT][videolfb] PD2236 mtkfb lcm name match succed\n");
			else {
				memset((void *)mtkfb_lcm_name, 0, sizeof(mtkfb_lcm_name));
				lcm_id_version = videolfb_tag->lcm_id;
				if (lcm_id_version == 0x68) {
					strncpy((char *)mtkfb_lcm_name, "pd2236_txd_jd9365t_hdplus_dsi_vdo",
						sizeof("pd2236_txd_jd9365t_hdplus_dsi_vdo"));
				} else if (lcm_id_version == 0x20) {
					strncpy((char *)mtkfb_lcm_name, "pd2236_ski651_icnl9911c_noflash_hdp_dsi_vdo",
						sizeof("pd2236_ski651_icnl9911c_noflash_hdp_dsi_vdo"));
				}  else if (lcm_id_version == 0x30) {
					strncpy((char *)mtkfb_lcm_name, "pd2236_tianma_ili9883c_hdplus_dsi_vdo",
						sizeof("pd2236_tianma_ili9883c_hdplus_dsi_vdo"));
			}
			mtkfb_lcm_name[strlen(mtkfb_lcm_name)] = '\0'; }
		}
