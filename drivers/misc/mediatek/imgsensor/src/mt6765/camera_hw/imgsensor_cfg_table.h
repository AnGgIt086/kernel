...
#define IMGSENSOR_HW_SENSOR_MAX_NUM	50
...
extern struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence_1_1V[];
extern struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence_1_2V[];
#endif
