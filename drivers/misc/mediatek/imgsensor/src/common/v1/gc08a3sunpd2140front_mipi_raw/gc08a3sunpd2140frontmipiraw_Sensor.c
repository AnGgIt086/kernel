...
#include "gc08a3sunpd2140frontmipiraw_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc08a3sunpd2140frontmipiraw_Sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC08A3SUNPD2140FRONT_SENSOR_ID,
...
static kal_uint32 return_sensor_id(void)
{
	...
	if (vendorid == 0x01) {
		sensor_id = (((read_cmos_sensor(0x03f0) << 8) | read_cmos_sensor(0x03f1)) + 3);
	} else {
			sensor_id = 0xFFFFFFFF;
	LOG_INF("QPF current sensor is not sun_front");
	}
...
/*out window*/
	...
	/*MIPI*/
	0x0114, 0x03,
	0x0180, 0x63,//refer to info from RF zhuzhuang on 2021.9.27
	0x0181, 0xf0,
	0x0185, 0x01,
	0x0115, 0x30,
	0x011b, 0x12,
...
/*MIPI*/
	0x0114, 0x03,
	0x0180, 0x64,//refer to info from RF zhuzhuang on 2021.9.27
	0x0181, 0xf0,
	0x0185, 0x01,
	0x0115, 0x30,
	0x011b, 0x12,
...
UINT32 GC08A3SUNPD2140FRONT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
