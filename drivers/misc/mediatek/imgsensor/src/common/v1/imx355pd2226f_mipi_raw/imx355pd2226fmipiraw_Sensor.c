...
extern int imx355pd2226f_otp_read(void);
int vivo_imx355pd2226f_otp_read_when_power_on;
extern otp_error_code_t IMX355PD2226F_OTP_ERROR_CODE;
MUINT32  sn_inf_sub_imx355pd2226f[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_imx355pd2226f[4];  
		...
		do {
			*sensor_id = ((read_cmos_sensor(0x0A0A) << 4) |read_cmos_sensor(0x0A0B) >> 4);
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_imx355pd2226f_otp_read_when_power_on = imx355pd2226f_otp_read();
				LOG_INF("cfx_add:end read eeprom ---vivo_imx355pd2226f_otp_read_when_power_on = %d,IMX355PD2226F_OTP_ERROR_CODE =%d\n", vivo_imx355pd2226f_otp_read_when_power_on, IMX355PD2226F_OTP_ERROR_CODE);
				return ERROR_NONE;
			}
			printk(
