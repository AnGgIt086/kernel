...
#include "gc08a3pd2139mipiraw_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc08a3pd2139_camera_sensor"
#define LOG_1 LOG_INF("GC08A3PD2139MIPI, 4LANE\n")
/****************************   Modify end    *******************************************/
#define GC08A3PD2139_DEBUG 0
#if GC08A3PD2139_DEBUG
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC08A3PD2139_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] =
{
	...
	{ 3264, 2448,	0,		0,	 3264, 2448, 1632, 1224, 0, 0, 1632, 1224,  0,  0, 1632, 1224}, // Preview // custom3	  
	{ 3264, 2448,	0,		0,	 3264, 2448, 1632, 1224, 0, 0, 1632, 1224,  0,  0, 1632, 1224}, // custom4	  
	{ 3264, 2448, 	0,	  304,	 3264, 1840, 3264, 1840, 0, 0, 3264, 1840,  0,  0, 3264, 1840}, // video // custom5	   
};

/****vivo caofeixiang add for CameraEM otp errorcode****/
extern int gc08a3pd2139_otp_read(void);
extern bool gc08a3pd2139_vivo_read_eeprom(kal_uint16 addr,  BYTE *data);
int vivo_gc08a3pd2139_otp_read_when_power_on;
extern otp_error_code_t GC08A3PD2139_OTP_ERROR_CODE;
MUINT32	sn_inf_sub_gc08a3pd2139[13];  /*0 flag	 1-12 data*/
MUINT32	material_inf_sub_gc08a3pd2139[4];  
...
kal_uint16 gc08a3pd2139_init_addr_data[] = {
	/*system*/
	0x031c, 0x60,
	0x0337, 0x04,
	0x0335, 0x51,
...
kal_uint16 gc08a3pd2139_1632x1224_addr_data[] = {
	/*system*/
	0x031c, 0x60,
	0x0337, 0x04,
	0x0335, 0x55,
...
kal_uint16 gc08a3pd2139_3264x2448_addr_data[] = {
	   /*system*/
	0x031c, 0x60,
	0x0337, 0x04,
	0x0335, 0x51,
...
kal_uint16 gc08a3pd2139_3264x1840_addr_data[] = {
		/*system*/
	0x031c, 0x60,
	0x0337, 0x04,
	0x0335, 0x51,
...
static void gc08a3pd2139_stream_on(void)
{
	write_cmos_sensor_8bit(0x0100, 0x01);
}

static void gc08a3pd2139_stream_off(void)
{
...
{
	table_write_cmos_sensor(gc08a3pd2139_init_addr_data,
		sizeof(gc08a3pd2139_init_addr_data)/sizeof(kal_uint16));
}

static void preview_setting(void)
{
	gc08a3pd2139_stream_off();
	table_write_cmos_sensor(gc08a3pd2139_1632x1224_addr_data,
		sizeof(gc08a3pd2139_1632x1224_addr_data)/sizeof(kal_uint16));
	gc08a3pd2139_stream_on();
}

static void capture_setting(void)
{
	gc08a3pd2139_stream_off();
	table_write_cmos_sensor(gc08a3pd2139_3264x2448_addr_data,
		sizeof(gc08a3pd2139_3264x2448_addr_data)/sizeof(kal_uint16));
	gc08a3pd2139_stream_on();
}
...
{
	gc08a3pd2139_stream_off();
	table_write_cmos_sensor(gc08a3pd2139_3264x1840_addr_data,
		sizeof(gc08a3pd2139_3264x1840_addr_data)/sizeof(kal_uint16));
	gc08a3pd2139_stream_on();
}
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_info("[gc08a3pd2139_camera_sensor]get_imgsensor_id:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
					vivo_gc08a3pd2139_otp_read_when_power_on = gc08a3pd2139_otp_read();
				pr_info("read eeprom ---vivo_gc08a3pd2139_otp_read_when_power_on = %d,GC08A3PD2139_OTP_ERROR_CODE =%d\n", vivo_gc08a3pd2139_otp_read_when_power_on, GC08A3PD2139_OTP_ERROR_CODE);
				return ERROR_NONE;
			}
			LOG_INF("[gc08a3pd2139_camera_sensor]get_imgsensor_id:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
static kal_uint32 open(void)
{
	...
	LOG_1;
	LOG_INF("gc08a3pd2139 open begin..\n");
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			sensor_id = return_sensor_id();
			if (sensor_id == imgsensor_info.sensor_id) {
				LOG_INF("[gc08a3pd2139_camera_sensor]open:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, sensor_id);
				break;
			}
			LOG_INF("[gc08a3pd2139_camera_sensor]open:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, sensor_id);
			retry--;
		} while (retry > 0);
		i++;
...
{
	LOG_INF("gc08a3pd2139 preview begin..\n");
	spin_lock(&imgsensor_drv_lock);
	...
	UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	{
		LOG_INF("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  GC08A3PD2139_OTP_ERROR_CODE:%d \n", *feature_data, GC08A3PD2139_OTP_ERROR_CODE);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = GC08A3PD2139_OTP_ERROR_CODE;
				memcpy(feature_data+2, sn_inf_sub_gc08a3pd2139, sizeof(MUINT32)*13); 
				memcpy(feature_data+10, material_inf_sub_gc08a3pd2139, sizeof(MUINT32)*4);
			}
			break;
		}
		break;
...
UINT32 GC08A3PD2139_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
