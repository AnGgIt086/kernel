...
extern int S5K4H7PD2226F_otp_read(void);
int vivo_sub_otp_read_when_power_on_s5k4h7pd2226f;
extern otp_error_code_t S5K4H7PD2226F_OTP_ERROR_CODE;
#endif
extern unsigned int is_atboot;
MUINT32  sn_inf_sub_s5k4h7pd2226f[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_s5k4h7pd2226f[4];  /*0 flag   1-12 data*/
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
 ...
 //        if(0 == ctidFlag){
        ...
        pr_debug("add:start read eeprom  - when_power_on  = %d\n",vivo_sub_otp_read_when_power_on_s5k4h7pd2226f);
        sensor_init();
        vivo_sub_otp_read_when_power_on_s5k4h7pd2226f=S5K4H7PD2226F_otp_read();
        pr_info("add:end read eeprom - when_power_on = %d\n",vivo_sub_otp_read_when_power_on_s5k4h7pd2226f);
        pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,S5K4H7PD2226F_OTP_ERROR_CODE=%d\n", vivo_sub_otp_read_when_power_on_s5k4h7pd2226f, S5K4H7PD2226F_OTP_ERROR_CODE);
		//vivo hope add end
        pr_info("i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);	  
        return ERROR_NONE;
			} else {
...
UINT32 S5K4H7PD2226F_MIPI_RAW_SensorInit(
