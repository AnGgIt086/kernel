 ...
 * Filename:
 * ---------
 *	 imx258qtepd2216mainmipiraw_Sensor.h
 *
 * Project:
 * --------
 *	 ALPS
 ...
 *
 ****************************************************************************/
#ifndef _IMX258QTEPD2216MAIN_SENSOR_H
#define _IMX258QTEPD2216MAIN_SENSOR_H
...
extern bool read_imx258pd2216_eeprom(kal_uint16 addr, BYTE *data, kal_uint32 size);
extern bool read_imx258pd2216_pdaf(kal_uint16 addr, BYTE *data, kal_uint32 size);

extern bool read_imx258pd2216_eeprom_SPC(
