...
extern int vivo_main_otp_read_hi846hltpd2236main(void);
int vivo_main_otp_read_when_power_on_hi846hltpd2236main;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI846HLTPD2236MAIN_SENSOR_ID,
	...
	.pre = {
		...
		.max_framerate = 300,
		.mipi_pixel_rate = 143868000, //(359.67M*4/10)
	},
	.cap = {
		.pclk = 287730000,
		.linelength = 3800,
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.max_framerate = 300,
		.mipi_pixel_rate = 287732000, //(719.33M * 4 / 10 )
	},
	.normal_video = {
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
 { 3280, 2464,   0,   4,   3280, 2456,   1640, 1228,   4, 2, 1632, 1224,   0, 0, 1632, 1224}, // preview
 { 3280, 2464,   0,   6,   3280, 2452,   3280, 2452,   8, 2, 3264, 2448,   0, 0, 3264, 2448}, // capture
 { 3280, 2464,   0,   4,   3280, 2456,   1640, 1228,   4, 2, 1632, 1224,   0, 0, 1632, 1224}, // video  
 { 3280, 2464,   0,   6,   3280, 2452,   3280, 2452,   8, 2, 3264, 2448,   0, 0, 3264, 2448}, // hight speed video
 { 3280, 2464,   0,   4,   3280, 2456,   1640, 1228,   4, 2, 1632, 1224,   0, 0, 1632, 1224}, // slim video
 { 3280, 2464,   0,   6,   3280, 2452,   3280, 2452,   8, 2, 3264, 2448,   0, 0, 3264, 2448}, // custom1
 { 3280, 2464,   0,   4,   3280, 2456,   1640, 1228,   4, 2, 1632, 1224,   0, 0, 1632, 1224}, // custom2
 { 3280, 2464,   0,   6,   3280, 2452,   3280, 2452,   8, 2, 3264, 2448,   0, 0, 3264, 2448}, // custom2
 { 3280, 2464,   0,   6,   3280, 2452,   3280, 2452,   8, 2, 3264, 2448,   0, 0, 3264, 2448}, // custom2
 { 3280, 2464,   0,   6,   3280, 2452,   3280, 2452,   8, 2, 3264, 2448,   0, 0, 3264, 2448}, // custom2
};
...
#endif
static unsigned short hi846_table_write_cmos_sensor_burst_mode(unsigned short* para, unsigned int len)
{
   char puSendCmd[I2C_BUFFER_LEN];
   ...
   while(IDX < len)
   {
		...
		else if (addr == (addr_last + 2))  //连续
		{
			// addr = para[IDX];         //continue data
			// puSendCmd[tosend++] = (char)(addr >> 8);
			// puSendCmd[tosend++] = (char)(addr & 0xFF);
		...
		if ((tosend == I2C_BUFFER_LEN) || (IDX == len) || (addr != (addr_last + 2)))
		{
			if(tosend < 5)
			{
				write_cmos_sensor(single_addr, single_data);
			}
...
// Hi-846_v10.5.1_24MHz_4lane_720Mbps_MTK_20200811.tsf
...
//MCLK/PCLK       : 26MHz /287.73Mhz
//MIPI speed(Mbps): 719.33Mbps x 4Lane
//Frame Length    : 2523
//Line Length     : 3800
//Max Fps         : 30.01fps(vblank>0.99ms)
...
//MCLK/PCLK       : 26MHz /287.73Mhz
//MIPI speed(Mbps): 359.67Mbps x 4Lane
//Frame Length    : 2523
//Line Length     : 3800
//Max Fps         : 30.01fps(vblank>17.1ms)
//Pixel order	  : Green 1st (=GR)
//X/Y-flip		  : Y-flip
//Firmware Ver.   : v10.5.1
////////////////////////////////////////////////
...
static kal_uint16 hi846_custom1_setting[] = {
//Sensor Information////////////////////////////
//Image size      : 3264x2448
//MCLK/PCLK       : 26MHz /287.73Mhz
//MIPI speed(Mbps): 719.33Mbps x 4Lane
...
static kal_uint16 hi846_custom2_setting[] = {
//Sensor Information////////////////////////////
//Image size	  : 1632x1224
//MCLK/PCLK       : 26MHz /287.73Mhz
//MIPI speed(Mbps): 359.67Mbps x 4Lane
...
static kal_uint16 hi846_custom3_setting[] = {
//Sensor Information////////////////////////////
//Image size	  : 3264x2448
//MCLK/PCLK       : 26MHz /287.73Mhz
//MIPI speed(Mbps): 719.33Mbps x 4Lane
//Frame Length    : 3154
//Line Length     : 3800
//Max Fps         : 24.00fps(vblank>9.323ms)
//Pixel order	  : Green 1st (=GR)
//X/Y-flip		  : Y-flip
//Firmware Ver.   : v10.5.1
////////////////////////////////////////////////
...
static kal_uint16 hi846_custom4_setting[] = {
//Sensor Information////////////////////////////
//Image size      : 3264x2448
//MCLK/PCLK       : 26MHz /287.73Mhz
//MIPI speed(Mbps): 719.33Mbps x 4Lane
//Frame Length    : 3785
//Line Length     : 3800
//Max Fps         : 20.01fps(vblank>17.6ms)
//Pixel order	  : Green 1st (=GR)
//X/Y-flip		  : Y-flip
//Firmware Ver.   : v10.5.1
////////////////////////////////////////////////
...
static kal_uint16 hi846_custom5_setting[] = {
//Sensor Information////////////////////////////
//Image size	  : 3264x2448
//MCLK/PCLK       : 26MHz /287.73Mhz
//MIPI speed(Mbps): 719.33Mbps x 4Lane
...
static void sensor_init(void)
{
	...
	hi846_table_write_cmos_sensor_burst_mode(hi846_init_setting,sizeof(hi846_init_setting)/sizeof(kal_uint16));
...
{
	pr_debug("%s E! 3264x2448@30fps\n", __func__);

	hi846_table_write_cmos_sensor(hi846_custom1_setting,
		sizeof(hi846_custom1_setting)/sizeof(kal_uint16));
...
static void custom2_setting(void)
{
	...
	hi846_table_write_cmos_sensor(hi846_custom2_setting,
		sizeof(hi846_custom2_setting)/sizeof(kal_uint16));
...
{
	pr_debug("%s E! 3264x2448@24fps\n", __func__);

	hi846_table_write_cmos_sensor(hi846_custom3_setting,
		sizeof(hi846_custom3_setting)/sizeof(kal_uint16));
...
{
	pr_debug("%s E! 3264x2448@20fps\n", __func__);

	hi846_table_write_cmos_sensor(hi846_custom4_setting,
		sizeof(hi846_custom4_setting)/sizeof(kal_uint16));
...
{
	pr_debug("%s E! 3264x2448@15fps\n", __func__);

	hi846_table_write_cmos_sensor(hi846_custom5_setting,
		sizeof(hi846_custom5_setting)/sizeof(kal_uint16));
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				sensor_init();
				/* add for CameraEM otp errorcode*/
				pr_info("[%d] add:start read eeprom ---vivo_main_otp_read_when_power_on_hi846hltpd2236main = %d\n", __LINE__, vivo_main_otp_read_when_power_on_hi846hltpd2236main);
				vivo_main_otp_read_when_power_on_hi846hltpd2236main = vivo_main_otp_read_hi846hltpd2236main();
				pr_info("[%d] add:start read eeprom ---vivo_main_otp_read_when_power_on_hi846hltpd2236main = %d\n", __LINE__, vivo_main_otp_read_when_power_on_hi846hltpd2236main);
				/* add end*/
				return ERROR_NONE;
			}
			  ...
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	pr_debug("%s HI-846 custom1 setting start \n", __func__);
	custom1_setting();
	pr_debug("%s HI-846 custom1 setting end \n", __func__);
			  ...
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	pr_debug("%s HI-846 custom2 setting start \n", __func__);
	custom2_setting();
	pr_debug("%s HI-846 custom2 setting end \n", __func__);
			  ...
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	pr_debug("%s HI-846 custom3 setting start \n", __func__);
	custom3_setting();
	pr_debug("%s HI-846 custom3 setting end \n", __func__);
			  ...
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	pr_debug("%s HI-846 custom4 setting start \n", __func__);
	custom4_setting();
	pr_debug("%s HI-846 custom4 setting end \n", __func__);
			  ...
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	pr_debug("%s HI-846 custom5 setting start \n", __func__);
	custom5_setting();
	pr_debug("%s HI-846 custom5 setting end \n", __func__);
...
/*add rawinfo end*/
	...
	case SENSOR_FEATURE_SET_AUTO_FLICKER_MODE:
		set_auto_flicker_mode((kal_bool)*feature_data_16,
				      *(feature_data_16+1));
		break;
...
UINT32 HI846HLTPD2236MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
