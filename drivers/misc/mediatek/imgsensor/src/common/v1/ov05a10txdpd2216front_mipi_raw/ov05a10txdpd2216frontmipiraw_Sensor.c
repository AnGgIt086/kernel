...
#include "ov05a10txdpd2216frontmipiraw_Sensor.h"
/****************************Modify Following Strings for Debug****************************/
#define PFX "FRONT_OV05A10TXDPD2216FRONT_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV05A10TXDPD2216FRONT_SENSOR_ID,
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if ((gain >= BASEGAIN) && (gain <= (15.5*BASEGAIN))) {
			...
			if (reg_gain <= 0x10) {
					...
					LOG_INF("OV05A10TXDPD2216FRONTMIPI reg_gain = %d, OV05A10TXDPD2216FRONTMIPI Gain = %d", reg_gain, gain);
...
UINT32 OV05A10TXDPD2216FRONT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
