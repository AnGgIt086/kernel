 ...
 * Filename:
 * ---------
 *     IMX355SWNPD2216MAINmipi_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "imx355swnpd2216mainmipiraw_Sensor.h"

/************************Modify Following Strings for Debug********************/
#define PFX "MAIN_IMX355SWNPD2216MAIN_camera_sensor_buyan"
#define LOG_1 LOG_INF("IMX355SWNPD2216MAIN,MIPI 4LANE\n")
/************************   Modify end    *************************************/

#define IMX355PD2216MAIN_SWN_EEPROM_VENDOR_ADDR 0x0001
#define IMX355PD2216MAIN_SWN_EEPROM_VENDOR_ID	0x5D
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX355SWNPD2216MAIN_SENSOR_ID,
	.checksum_value = 0xD1EFF68B,
	.hs_trail = 0x3C,

	.pre = {
		.pclk = 202000000,				//record different mode's pclk
		.linelength  = 1836,				//record different mode's linelength
		.framelength = 3658,			/*record different mode's framelength*/
	...
	.cap = {
		.pclk = 279000000,				//record different mode's pclk
	...
	.custom3 = {
		.pclk = 223000000,				//record different mode's pclk
		.linelength  = 3672,				//record different mode's linelength
	...
	.custom4 = {
		.pclk = 202000000,				//record different mode's pclk
		.linelength  = 3672,				//record different mode's linelength
		.framelength = 2742,			/*record different mode's framelength*/
		.startx = 0,					//record different mode's startx of grabwindow
		.starty = 0,					//record different mode's starty of grabwindow
		.grabwindow_width  = 3264,   /*2592 record different mode's width of grabwindow*/
		.grabwindow_height = 2448,	 /*1944record different mode's height of grabwindow*/
	...
	.custom5 = {
		.pclk = 202000000,				//record different mode's pclk
		.linelength  = 3672,				//record different mode's linelength
		.framelength = 3656,			/*record different mode's framelength*/
		.startx = 0,					//record different mode's startx of grabwindow
		.starty = 0,					//record different mode's starty of grabwindow
		.grabwindow_width  = 3264,   /*2592 record different mode's width of grabwindow*/
		.grabwindow_height = 2448,	 /*1944record different mode's height of grabwindow*/
	...
	.i2c_addr_table = {0x34, 0x6c, 0xff},//record sensor support all write id addr, only supprt 4must end with 0xff
...
extern int imx355swnpd2216main_otp_read(void);
extern bool imx355swnpd2216main_vivo_read_eeprom(kal_uint16 addr,  BYTE *data);
int vivo_imx355swnpd2216main_otp_read_when_power_on;
extern otp_error_code_t IMX355SWNPD2216MAIN_OTP_ERROR_CODE;
MUINT32  sn_inf_sub_imx355swnpd2216main[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_imx355swnpd2216main[4];
...
/* if shutter bigger than frame_length, should extend frame length first */
	...
	#define IMX355SWNPD2216MAINMIPI_MaxGainIndex (389)
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	kal_uint16 iI;

	kal_uint16 imx355swnpd2216mainMIPI_sensorGainMapping[IMX355SWNPD2216MAINMIPI_MaxGainIndex][2] = {
	{64, 0},
	{65, 16},
	{66, 32},
	{67, 46},
	...
	for (iI = 0; iI < IMX355SWNPD2216MAINMIPI_MaxGainIndex; iI++) {
		if (gain <= imx355swnpd2216mainMIPI_sensorGainMapping[iI][0])
			return imx355swnpd2216mainMIPI_sensorGainMapping[iI][1];
	}

	return imx355swnpd2216mainMIPI_sensorGainMapping[iI - 1][1];
}
...
#endif
static kal_uint16 imx355swnpd2216main_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_init_imx355swnpd2216main[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x4348, 0x16,
	0x4350, 0x19,
...
/*3264x2448@30fps*/
kal_uint16 addr_data_pair_full_size_imx355swnpd2216main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*3264x1840@30fps*/
kal_uint16 addr_data_pair_crop_size_imx355swnpd2216main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*1632x1224@30fps*/
kal_uint16 addr_data_pair_bining_size_imx355swnpd2216main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x07,
...
/*1632x1224@30fps*/
kal_uint16 addr_data_pair_normal_video_size_imx355swnpd2216main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x07,
...
/*1632x1224@30fps*/
kal_uint16 addr_data_pair_slim_video_size_imx355swnpd2216main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x07,
...
/*3264x2448@30fps*/
kal_uint16 addr_data_pair_hs_video_size_imx355swnpd2216main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*3264x2448@30fps*/
kal_uint16 addr_data_pair_custom1_size_imx355swnpd2216main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*1632x1224@30fps*/
kal_uint16 addr_data_pair_custom2_size_imx355swnpd2216main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x07,
...
/*3264x2448@24fps*/
kal_uint16 addr_data_pair_custom3_size_imx355swnpd2216main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*3264x2448@20fps*/
kal_uint16 addr_data_pair_custom4_size_imx355swnpd2216main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*3264x2448@15fps*/
kal_uint16 addr_data_pair_custom5_size_imx355swnpd2216main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
{
	imx355swnpd2216main_table_write_cmos_sensor(addr_data_pair_init_imx355swnpd2216main,
		sizeof(addr_data_pair_init_imx355swnpd2216main)/sizeof(kal_uint16));
}


static void full_size_setting(void)
{
	imx355swnpd2216main_table_write_cmos_sensor(addr_data_pair_full_size_imx355swnpd2216main,
	sizeof(addr_data_pair_full_size_imx355swnpd2216main) / sizeof(kal_uint16));
}

static void binning_size_setting(void)
{
	imx355swnpd2216main_table_write_cmos_sensor(addr_data_pair_bining_size_imx355swnpd2216main,
	sizeof(addr_data_pair_bining_size_imx355swnpd2216main) / sizeof(kal_uint16));
}

static void normal_video_size_setting(void)
{
	imx355swnpd2216main_table_write_cmos_sensor(addr_data_pair_normal_video_size_imx355swnpd2216main,
	sizeof(addr_data_pair_normal_video_size_imx355swnpd2216main) / sizeof(kal_uint16));
}

static void slim_video_size_setting(void)
{
	imx355swnpd2216main_table_write_cmos_sensor(addr_data_pair_slim_video_size_imx355swnpd2216main,
	sizeof(addr_data_pair_slim_video_size_imx355swnpd2216main) / sizeof(kal_uint16));
}

static void hs_video_size_setting(void)
{
	imx355swnpd2216main_table_write_cmos_sensor(addr_data_pair_hs_video_size_imx355swnpd2216main,
	sizeof(addr_data_pair_hs_video_size_imx355swnpd2216main) / sizeof(kal_uint16));
}

static void custom1_size_setting(void)
{
	imx355swnpd2216main_table_write_cmos_sensor(addr_data_pair_custom1_size_imx355swnpd2216main,
	sizeof(addr_data_pair_custom1_size_imx355swnpd2216main) / sizeof(kal_uint16));
}

static void custom2_size_setting(void)
{
	imx355swnpd2216main_table_write_cmos_sensor(addr_data_pair_custom2_size_imx355swnpd2216main,
	sizeof(addr_data_pair_custom2_size_imx355swnpd2216main) / sizeof(kal_uint16));
}

static void custom3_size_setting(void)
{
	imx355swnpd2216main_table_write_cmos_sensor(addr_data_pair_custom3_size_imx355swnpd2216main,
	sizeof(addr_data_pair_custom3_size_imx355swnpd2216main) / sizeof(kal_uint16));
}

static void custom4_size_setting(void)
{
	imx355swnpd2216main_table_write_cmos_sensor(addr_data_pair_custom4_size_imx355swnpd2216main,
	sizeof(addr_data_pair_custom4_size_imx355swnpd2216main) / sizeof(kal_uint16));
}

static void custom5_size_setting(void)
{
	imx355swnpd2216main_table_write_cmos_sensor(addr_data_pair_custom5_size_imx355swnpd2216main,
	sizeof(addr_data_pair_custom5_size_imx355swnpd2216main) / sizeof(kal_uint16));
}
...
//get vendorid from eeprom
static kal_uint16 get_vendor_id(void)
{
	kal_uint16 get_byte = 0;
	kal_uint32 addr = IMX355PD2216MAIN_SWN_EEPROM_VENDOR_ADDR;
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	//unsigned char material_inf_imx355swnpd2216main[4] ={0,0,0,0};
    //int offset = 0x0F;
	...
	timeout = check_i2c_timeout(0x0101, imgsensor.i2c_write_id);
	if (timeout) {
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		spin_unlock(&imgsensor_drv_lock);
		do {vendorid = get_vendor_id();
			LOG_INF("vendor id = 0x%x", vendorid);
			if (vendorid == IMX355PD2216MAIN_SWN_EEPROM_VENDOR_ID) {
				*sensor_id = ((read_cmos_sensor(0x0A0A) << 4) | (read_cmos_sensor(0x0A0B) >> 4) + 1);
			} else {
				*sensor_id = 0xFFFFFFFF;
				LOG_INF("current sensor is not imx355swnmain, vendor id = 0x%x", vendorid);
			}
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
...
#if 0
				for (j = 0; j < 4; j++) {
					imx355swnpd2216main_vivo_read_eeprom(offset, &material_inf_imx355swnpd2216main[j]);
					offset++;
				}
				pr_info("i2c write id: 0x%x, sensor id: 0x%x material_inf_imx355swnpd2216main=0x%x\n", imgsensor.i2c_write_id, *sensor_id, ((unsigned int)material_inf_imx355swnpd2216main[0]<<24|(unsigned int)material_inf_imx355swnpd2216main[1]<<16|(unsigned int)material_inf_imx355swnpd2216main[2]<<8|(unsigned int)material_inf_imx355swnpd2216main[3]));
				if ((unsigned int)material_inf_imx355swnpd2216main[3] == 0x80) {
					if (*sensor_id == imgsensor_info.sensor_id) {
					LOG_INF("i2c write id: 0x%x, sensor id: 0x%x material_inf_imx355swnpd2216main=0x%x\n", imgsensor.i2c_write_id, *sensor_id, ((unsigned int)material_inf_imx355swnpd2216main[0]<<24|(unsigned int)material_inf_imx355swnpd2216main[1]<<16|(unsigned int)material_inf_imx355swnpd2216main[2]<<8|(unsigned int)material_inf_imx355swnpd2216main[3]));
				//	if (is_atboot == 1) {
				...
				//	}
					...
					vivo_imx355swnpd2216main_otp_read_when_power_on = imx355swnpd2216main_otp_read();
					pr_info("read eeprom ---vivo_imx355swnpd2216main_otp_read_when_power_on = %d,IMX355SWNPD2216MAIN_OTP_ERROR_CODE =%d\n", vivo_imx355swnpd2216main_otp_read_when_power_on, IMX355SWNPD2216MAIN_OTP_ERROR_CODE);
					return ERROR_NONE;
				}
			} else {
				pr_err("material_inf_imx355swnpd2216main[3]=0x%x != 0x80", material_inf_imx355swnpd2216main[3]);
				*sensor_id = 0xFFFFFFFF;
				return ERROR_SENSOR_CONNECT_FAIL;
			}
// #else
...
static kal_uint32 open(void)
{
	...
	LOG_1;
	LOG_INF("imx355swnpd2216main open begin..\n");
	...
	if (imgsensor_info.sensor_id != sensor_id)
		return ERROR_SENSOR_CONNECT_FAIL;
	KD_SENSOR_PROFILE("imx355swnpd2216main get sensor id time");
	/* initail sequence write in  */
	global_setting();
	KD_SENSOR_PROFILE("imx355swnpd2216main set global setting time");
	...
	spin_unlock(&imgsensor_drv_lock);
	LOG_INF("imx355swnpd2216main open end..\n");
	return ERROR_NONE;
} /* open */
...
{
	LOG_INF("imx355swnpd2216main close begin..\n");
	write_cmos_sensor(0x0100, 0x00);
	return ERROR_NONE;
}
...
{
	LOG_INF("imx355swnpd2216main preview begin..\n");
	spin_lock(&imgsensor_drv_lock);
	...
	KD_SENSOR_PROFILE("imx355swnpd2216main set binning size setting time");
	return ERROR_NONE;
}
...
static kal_uint32 capture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	LOG_INF("imx355swnpd2216main preview capture..\n");
	spin_lock(&imgsensor_drv_lock);
	...
	KD_SENSOR_PROFILE_INIT();
	full_size_setting();
	KD_SENSOR_PROFILE("imx355swnpd2216main set full size setting time");
	...
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	KD_SENSOR_PROFILE_INIT();
	normal_video_size_setting();
	KD_SENSOR_PROFILE("imx355swnpd2216main set crop size setting time");
...
static kal_uint32 imx355swnpd2216main_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
 ...
 */
	...
	case SENSOR_FEATURE_SET_AWB_GAIN:
		imx355swnpd2216main_awb_gain(pSetSensorAWB);
		break;
	...
	{
		LOG_INF("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  IMX355SWNPD2216MAIN_OTP_ERROR_CODE:%d\n", *feature_data, IMX355SWNPD2216MAIN_OTP_ERROR_CODE);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = IMX355SWNPD2216MAIN_OTP_ERROR_CODE;
				memcpy(feature_data+2, sn_inf_sub_imx355swnpd2216main, sizeof(MUINT32)*13);
				memcpy(feature_data+10, material_inf_sub_imx355swnpd2216main, sizeof(MUINT32)*4);
			}
			break;
		}
		break;
...
UINT32 IMX355SWNPD2216MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
