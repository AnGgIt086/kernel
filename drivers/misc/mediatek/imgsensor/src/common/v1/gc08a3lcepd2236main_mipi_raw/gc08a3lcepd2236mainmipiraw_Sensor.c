 ...
 *============================================================================
 *
 * Version:  V20210616110341 by GC-S-TEAM
 *
...
#define PFX "gc08a3lcepd2236mainmipiraw_Sensor"
...
extern int vivo_main_otp_read_gc08a3lcepd2236main(void);
int vivo_main_otp_read_when_power_on_gc08a3lcepd2236main;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC08A3LCEPD2236MAIN_SENSOR_ID,
...
static struct imgsensor_struct imgsensor = {
	.mirror = IMAGE_HV_MIRROR, // wayoung
...
static kal_uint16 gc08a3_3264x2448_20fps_addr_data[] = {
/*system*/
	0x031c, 0x60,
	0x0337, 0x04,
	0x0335, 0x51,
...
static kal_uint16 gc08a3_640x480_addr_data[] = {
		/*system*/
	0x031c, 0x60,
	0x0337, 0x04,
	0x0335, 0x55,
...
{
	gc08a3_stream_off();
	table_write_cmos_sensor(gc08a3_3264x2448_20fps_addr_data,
		sizeof(gc08a3_3264x2448_20fps_addr_data)/sizeof(kal_uint16));
	gc08a3_stream_on();
}
...
{
	gc08a3_stream_off();
	table_write_cmos_sensor(gc08a3_640x480_addr_data,
		sizeof(gc08a3_640x480_addr_data)/sizeof(kal_uint16));
	gc08a3_stream_on();
}
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				pr_info("[%d] add:start read eeprom ---vivo_main_otp_read_when_power_on_gc08a3lcepd2236main = %d\n", __LINE__, vivo_main_otp_read_when_power_on_gc08a3lcepd2236main);
				vivo_main_otp_read_when_power_on_gc08a3lcepd2236main = vivo_main_otp_read_gc08a3lcepd2236main();
				pr_info("[%d] add:end read eeprom ---vivo_main_otp_read_when_power_on_gc08a3lcepd2236main = %d\n", __LINE__, vivo_main_otp_read_when_power_on_gc08a3lcepd2236main);
				/* add end*/
				return ERROR_NONE;
			}
...
UINT32 GC08A3LCEPD2236MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
