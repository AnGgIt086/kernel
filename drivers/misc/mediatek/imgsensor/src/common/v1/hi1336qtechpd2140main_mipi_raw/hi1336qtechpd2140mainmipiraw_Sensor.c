...
#include "hi1336qtechpd2140mainmipiraw_Sensor.h"

#define PFX "hi1336qtech_camera_sensor"
...
extern bool read_eeprom_qtech(kal_uint16 addr, BYTE *data, kal_uint32 size);
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI1336QTECHPD2140MAIN_SENSOR_ID,
...
static kal_uint16 hi1336qtech_table_write_cmos_sensor(
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
	...
	switch (image_mirror) {
	case IMAGE_NORMAL:
		write_cmos_sensor(0x0202, 0b1000000000);
		break;
	case IMAGE_H_MIRROR:
		write_cmos_sensor(0x0202, 0b1000000000);
...
kal_uint16 addr_data_pair_init_hi1336qtech[] = {
	0x2000, 0x0021,
	0x2002, 0x04a5,
	0x2004, 0xb124,
	0x2006, 0xc09c,
...
{
	hi1336qtech_table_write_cmos_sensor(
		addr_data_pair_init_hi1336qtech,
		sizeof(addr_data_pair_init_hi1336qtech) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_preview_hi1336qtech[] = {
	0x3250, 0xa470,
	0x0730, 0x770f,
	0x0732, 0xe1b0,
	0x1118, 0x0004,
...
{
	hi1336qtech_table_write_cmos_sensor(
		addr_data_pair_preview_hi1336qtech,
		sizeof(addr_data_pair_preview_hi1336qtech) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_capture_30fps_hi1336qtech[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0006,
...
kal_uint16 addr_data_pair_capture_15fps_hi1336qtech[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0006,
...
static void capture_setting(kal_uint16 currefps)
{
	if (currefps == 300) {
	hi1336qtech_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_hi1336qtech,
		sizeof(addr_data_pair_capture_30fps_hi1336qtech) /
		sizeof(kal_uint16));

	} else {
	hi1336qtech_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_hi1336qtech,
		sizeof(addr_data_pair_capture_15fps_hi1336qtech) /
		sizeof(kal_uint16));
	}
}

kal_uint16 addr_data_pair_video_hi1336qtech[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x017e,
...
{
	hi1336qtech_table_write_cmos_sensor(
		addr_data_pair_video_hi1336qtech,
		sizeof(addr_data_pair_video_hi1336qtech) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_hs_video_hi1336qtech[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe2b0,
	0x1118, 0x01a8,
...
{
	hi1336qtech_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi1336qtech,
		sizeof(addr_data_pair_hs_video_hi1336qtech) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_slim_video_hi1336qtech[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe2b0,
	0x1118, 0x01a8,
...
{
	hi1336qtech_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi1336qtech,
		sizeof(addr_data_pair_slim_video_hi1336qtech) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_custom1_hi1336qtech[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0156,
...
{
	hi1336qtech_table_write_cmos_sensor(
		addr_data_pair_custom1_hi1336qtech,
		sizeof(addr_data_pair_custom1_hi1336qtech) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_custom2_hi1336qtech[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0156,
...
{
	hi1336qtech_table_write_cmos_sensor(
		addr_data_pair_custom2_hi1336qtech,
		sizeof(addr_data_pair_custom2_hi1336qtech) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_custom3_hi1336qtech[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0156,
...
{
	hi1336qtech_table_write_cmos_sensor(
		addr_data_pair_custom3_hi1336qtech,
		sizeof(addr_data_pair_custom3_hi1336qtech) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_custom4_hi1336qtech[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0156,
...
{
	hi1336qtech_table_write_cmos_sensor(
		addr_data_pair_custom4_hi1336qtech,
		sizeof(addr_data_pair_custom4_hi1336qtech) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_custom5_hi1336qtech[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0156,
...
{
	hi1336qtech_table_write_cmos_sensor(
		addr_data_pair_custom5_hi1336qtech,
		sizeof(addr_data_pair_custom5_hi1336qtech) /
		sizeof(kal_uint16));
}
...
static kal_uint32 open(void)
{
	...
	LOG_INF("[open]: hi1336qtech@MT6765,MIPI 4LANE\n");
...
/*add rawinfo end*/
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		// read from e2prom
#if e2prom
		read_eeprom_qtech((kal_uint16)(*feature_data),
...
UINT32 HI1336QTECHPD2140MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
