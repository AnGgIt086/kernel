 ...
 * Filename:
 * ---------
 *     IMX355SUNPD2140FRONTmipi_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "imx355sunpd2140frontmipiraw_Sensor.h"

/************************Modify Following Strings for Debug********************/
#define PFX "SUB_IMX355SUNPD2140FRONT_camera_sensor_buyan"
#define LOG_1 LOG_INF("IMX355SUNPD2140FRONT,MIPI 4LANE\n")
/************************   Modify end    *************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX355SUNPD2140FRONT_SENSOR_ID,
	...
	.pre = {
		...
		.framelength = 3650,			/*record different mode's framelength*/
		...
		.mipi_pixel_rate = 201068000,	
		.max_framerate = 300,
	},

	.cap = {
		.pclk = 274000000,				//record different mode's pclk
		.linelength  = 3672,				//record different mode's linelength
		.framelength = 2486,			/*record different mode's framelength*/
		.startx = 0,					//record different mode's startx of grabwindow
		.starty = 0,					//record different mode's starty of grabwindow
		...
		/*	 following for MIPIDataLowPwr2HighSpeedSettleDelayCount by different scenario	*/
		.mipi_data_lp2hs_settle_dc = 14,	
		.mipi_pixel_rate = 273868000,
		.max_framerate = 300,
	},

	.normal_video = {
		.pclk = 208000000,				//record different mode's pclk
		.linelength = 3672,				//record different mode's linelength
		.framelength = 1888,			/*record different mode's framelength*/
		.startx = 0,					//record different mode's startx of grabwindow
		.starty = 0,					//record different mode's starty of grabwindow
	...
	.i2c_addr_table = {0x6c,0x34,0xff},//record sensor support all write id addr, only supprt 4must end with 0xff
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] =
{
	...
	{3264, 2448, 0,   0, 3264, 2448, 1632, 1224, 496, 372,  640,  480, 0, 0,  640,  480}  // custom5	   
};

#if 0
/****vivo caofeixiang add for CameraEM otp errorcode****/
extern int imx355sunpd2140front_otp_read(void);
extern bool imx355sunpd2140front_vivo_read_eeprom(kal_uint16 addr,  BYTE *data);
int vivo_imx355sunpd2140front_otp_read_when_power_on;
extern otp_error_code_t IMX355SUNPD2140FRONT_OTP_ERROR_CODE;
MUINT32  sn_inf_sub_imx355sunpd2140front[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_imx355sunpd2140front[4];  
...
/* if shutter bigger than frame_length, should extend frame length first */
	...
	#define IMX355SUNPD2140FRONTMIPI_MaxGainIndex (389)
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	kal_uint16 iI;

	kal_uint16 imx355sunpd2140frontMIPI_sensorGainMapping[IMX355SUNPD2140FRONTMIPI_MaxGainIndex][2] = {
	{64, 0},
	{65, 16},
	{66, 32},
	{67, 46},
	...
	for (iI = 0; iI < IMX355SUNPD2140FRONTMIPI_MaxGainIndex; iI++) {
		if (gain <= imx355sunpd2140frontMIPI_sensorGainMapping[iI][0])
			return imx355sunpd2140frontMIPI_sensorGainMapping[iI][1];
	}

	return imx355sunpd2140frontMIPI_sensorGainMapping[iI - 1][1];
}
...
#endif
static kal_uint16 imx355sunpd2140front_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_init_imx355sunpd2140front[] = {
	0x0136, 0x1A,   //terry add
	0x0137, 0x00,   //terry add
	0x4348, 0x16,
	0x4350, 0x19,
	0x4408, 0x0A,
	0x440C, 0x0B,
...
/*3264x2448@30fps*/
kal_uint16 addr_data_pair_full_size_imx355sunpd2140front[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*3264x1840@30fps*/
kal_uint16 addr_data_pair_crop_size_imx355sunpd2140front[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*1632x1224@30fps*/
kal_uint16 addr_data_pair_bining_size_imx355sunpd2140front[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x07,
...
/*1632x1224@30fps*/
kal_uint16 addr_data_pair_slim_video_size_imx355sunpd2140front[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x07,
...
/*3264x2448@30fps*/
kal_uint16 addr_data_pair_hs_video_size_imx355sunpd2140front[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*3264x2448@30fps*/
kal_uint16 addr_data_pair_custom1_size_imx355sunpd2140front[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*1632x1224@30fps*/
kal_uint16 addr_data_pair_custom2_size_imx355sunpd2140front[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x07,
...
/*3264x2448@30fps*/
kal_uint16 addr_data_pair_custom3_size_imx355sunpd2140front[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*3264x2448@20fps*/
kal_uint16 addr_data_pair_custom4_size_imx355sunpd2140front[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*640x480@15fps*/
kal_uint16 addr_data_pair_custom5_size_imx355sunpd2140front[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
{
	imx355sunpd2140front_table_write_cmos_sensor(addr_data_pair_init_imx355sunpd2140front,
		sizeof(addr_data_pair_init_imx355sunpd2140front)/sizeof(kal_uint16));
}


static void full_size_setting(void)
{
	imx355sunpd2140front_table_write_cmos_sensor(addr_data_pair_full_size_imx355sunpd2140front,
	sizeof(addr_data_pair_full_size_imx355sunpd2140front) / sizeof(kal_uint16));
}

static void crop_size_setting(void)
{
	imx355sunpd2140front_table_write_cmos_sensor(addr_data_pair_crop_size_imx355sunpd2140front,
	sizeof(addr_data_pair_crop_size_imx355sunpd2140front) / sizeof(kal_uint16));
}

static void binning_size_setting(void)
{
	imx355sunpd2140front_table_write_cmos_sensor(addr_data_pair_bining_size_imx355sunpd2140front,
	sizeof(addr_data_pair_bining_size_imx355sunpd2140front) / sizeof(kal_uint16));
}

static void slim_video_size_setting(void)
{
	imx355sunpd2140front_table_write_cmos_sensor(addr_data_pair_slim_video_size_imx355sunpd2140front,
	sizeof(addr_data_pair_slim_video_size_imx355sunpd2140front) / sizeof(kal_uint16));
}

static void hs_video_size_setting(void)
{
	imx355sunpd2140front_table_write_cmos_sensor(addr_data_pair_hs_video_size_imx355sunpd2140front,
	sizeof(addr_data_pair_hs_video_size_imx355sunpd2140front) / sizeof(kal_uint16));
}

static void custom1_size_setting(void)
{
	imx355sunpd2140front_table_write_cmos_sensor(addr_data_pair_custom1_size_imx355sunpd2140front,
	sizeof(addr_data_pair_custom1_size_imx355sunpd2140front) / sizeof(kal_uint16));
}

static void custom2_size_setting(void)
{
	imx355sunpd2140front_table_write_cmos_sensor(addr_data_pair_custom2_size_imx355sunpd2140front,
	sizeof(addr_data_pair_custom2_size_imx355sunpd2140front) / sizeof(kal_uint16));
}
...
{
	imx355sunpd2140front_table_write_cmos_sensor(addr_data_pair_custom4_size_imx355sunpd2140front,
	sizeof(addr_data_pair_custom4_size_imx355sunpd2140front) / sizeof(kal_uint16));
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0/*,j = 0*/;
	kal_uint8 retry = 2;
	//unsigned char material_inf_imx355sunpd2140front[4] ={0,0,0,0};
    //int offset = 0x0F;
			...
			*sensor_id = ((read_cmos_sensor(0x0A0A) << 4) |read_cmos_sensor(0x0A0B) >> 4);
			if (*sensor_id == imgsensor_info.sensor_id) {
...
#if 0
				for(j = 0;j < 4;j++){
					imx355sunpd2140front_vivo_read_eeprom(offset,&material_inf_imx355sunpd2140front[j]);	
					offset++;
				}
				pr_info("i2c write id: 0x%x, sensor id: 0x%x material_inf_imx355sunpd2140front=0x%x\n", imgsensor.i2c_write_id,*sensor_id,((unsigned int)material_inf_imx355sunpd2140front[0]<<24|(unsigned int)material_inf_imx355sunpd2140front[1]<<16|(unsigned int)material_inf_imx355sunpd2140front[2]<<8|(unsigned int)material_inf_imx355sunpd2140front[3]));
				if((unsigned int)material_inf_imx355sunpd2140front[3] == 0x80) {
					if (*sensor_id == imgsensor_info.sensor_id) {
					LOG_INF("i2c write id: 0x%x, sensor id: 0x%x material_inf_imx355sunpd2140front=0x%x\n", imgsensor.i2c_write_id,*sensor_id,((unsigned int)material_inf_imx355sunpd2140front[0]<<24|(unsigned int)material_inf_imx355sunpd2140front[1]<<16|(unsigned int)material_inf_imx355sunpd2140front[2]<<8|(unsigned int)material_inf_imx355sunpd2140front[3]));
				//	if (is_atboot == 1) {
				...
				//	}
        				...
        				vivo_imx355sunpd2140front_otp_read_when_power_on = imx355sunpd2140front_otp_read();
        				pr_info("read eeprom ---vivo_imx355sunpd2140front_otp_read_when_power_on = %d,IMX355SUNPD2140FRONT_OTP_ERROR_CODE =%d\n", vivo_imx355sunpd2140front_otp_read_when_power_on, IMX355SUNPD2140FRONT_OTP_ERROR_CODE);
        				return ERROR_NONE;
				}
			    }else {
                                pr_err("material_inf_imx355sunpd2140front[3]=0x%x != 0x80",material_inf_imx355sunpd2140front[3] );
                                *sensor_id = 0xFFFFFFFF;
                                return ERROR_SENSOR_CONNECT_FAIL;
                        }
// #else
...
static kal_uint32 open(void)
{
	...
	kal_uint8 retry = 2;
	LOG_1;
	LOG_INF("imx355sunpd2140front open begin..\n");
	...
	if (imgsensor_info.sensor_id != sensor_id)
		return ERROR_SENSOR_CONNECT_FAIL;
	KD_SENSOR_PROFILE("imx355sunpd2140front get sensor id time");
	/* initail sequence write in  */
	global_setting();
	KD_SENSOR_PROFILE("imx355sunpd2140front set global setting time");
	...
	spin_unlock(&imgsensor_drv_lock);
	LOG_INF("imx355sunpd2140front open end..\n");
	return ERROR_NONE;
} /* open */
...
{
	LOG_INF("imx355sunpd2140front close begin..\n");
	write_cmos_sensor(0x0100, 0x00);
	return ERROR_NONE;
}
...
{
	LOG_INF("imx355sunpd2140front preview begin..\n");
	spin_lock(&imgsensor_drv_lock);
	...
	KD_SENSOR_PROFILE("imx355sunpd2140front set binning size setting time");
	return ERROR_NONE;
}
...
static kal_uint32 capture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	LOG_INF("imx355sunpd2140front preview capture..\n");
	spin_lock(&imgsensor_drv_lock);
	...
	KD_SENSOR_PROFILE_INIT();
	full_size_setting();
	KD_SENSOR_PROFILE("imx355sunpd2140front set full size setting time");
	...
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	KD_SENSOR_PROFILE_INIT();
	crop_size_setting();
	KD_SENSOR_PROFILE("imx355sunpd2140front set crop size setting time");
...
static kal_uint32 imx355sunpd2140front_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
 ...
 */
	...
	case SENSOR_FEATURE_SET_AWB_GAIN:
		imx355sunpd2140front_awb_gain(pSetSensorAWB);
		break;
	...
	{
		LOG_INF("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  IMX355SUNPD2140FRONT_OTP_ERROR_CODE:%d \n", *feature_data, IMX355SUNPD2140FRONT_OTP_ERROR_CODE);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = IMX355SUNPD2140FRONT_OTP_ERROR_CODE;
				memcpy(feature_data+2, sn_inf_sub_imx355sunpd2140front, sizeof(MUINT32)*13); 
				memcpy(feature_data+10, material_inf_sub_imx355sunpd2140front, sizeof(MUINT32)*4);
			}
			break;
		}
		break;
...
UINT32 IMX355SUNPD2140FRONT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
