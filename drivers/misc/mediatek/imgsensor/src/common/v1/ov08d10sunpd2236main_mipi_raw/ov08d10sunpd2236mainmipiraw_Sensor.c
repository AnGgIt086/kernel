...
#include "ov08d10sunpd2236mainmipiraw_Sensor.h"

#define PFX "OV08D10SUNPD2236MAIN_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV08D10SUNPD2236MAIN_SENSOR_ID,

	.checksum_value = 0xdac1f07c,       //0x6d01485c // Auto Test Mode

	.pre = {
		.pclk = 36400000,            //record different mode's pclk
		.linelength = 478,            //record different mode's linelength
		.framelength = 2532,            //record different mode's framelength
	...
	.cap = {
		.pclk = 36075000,            //record different mode's pclk
    ...
    .custom4 = {
		.pclk = 36075000,            //record different mode's pclk
		.linelength = 460,            //record different mode's linelength
		.framelength = 3912,            //record different mode's framelength
		.startx = 0,                    //record different mode's startx of grabwindow
		.starty = 0,                    //record different mode's starty of grabwindow
		.grabwindow_width = 3264,        //record different mode's width of grabwindow
		.grabwindow_height = 2448,        //record different mode's height of grabwindow
    ...
    .custom5 = {
		.pclk = 36075000,            //record different mode's pclk
		.linelength = 460,            //record different mode's linelength
		.framelength = 5216,            //record different mode's framelength
		.startx = 0,                    //record different mode's startx of grabwindow
		.starty = 0,                    //record different mode's starty of grabwindow
		.grabwindow_width = 3264,        //record different mode's width of grabwindow
		.grabwindow_height = 2448,        //record different mode's height of grabwindow
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0xfd, 0x01);//add for mirror&flip
	write_cmos_sensor(0x32, 0x03);//add for mirror&flip
	write_cmos_sensor(0x01, 0x01);//add for mirror&flip
	...
	write_cmos_sensor(0x10, 0x0c);//0x00 modify for mirror&flip
	write_cmos_sensor(0x11, 0xcf);//0x00 modify for mirror&flip
	write_cmos_sensor(0x12, 0x00);//0x0c modify for mirror&flip
	write_cmos_sensor(0x13, 0x00);//0xcf modify for mirror&flip
	write_cmos_sensor(0x14, 0x09);//0x00 modify for mirror&flip
	write_cmos_sensor(0x15, 0x9f);//0x00 modify for mirror&flip
...
static void custom5_setting(void)
{
	...
	write_cmos_sensor(0x03, 0x12);
	write_cmos_sensor(0x04, 0x50);
	write_cmos_sensor(0x05, 0x15);
	write_cmos_sensor(0x06, 0x30);
	write_cmos_sensor(0x07, 0x05);
	write_cmos_sensor(0x21, 0x02);
	write_cmos_sensor(0x24, 0x30);
	write_cmos_sensor(0x33, 0x03);
...
UINT32 OV08D10SUNPD2236MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
