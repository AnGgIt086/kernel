...
#include "hi1336sunnypd2140mainmipiraw_Sensor.h"

#define PFX "hi1336sunny_camera_sensor"
...
extern bool read_eeprom_sunny(kal_uint16 addr, BYTE *data, kal_uint32 size);
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI1336SUNNYPD2140MAIN_SENSOR_ID,
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gr, //wayoung modify for hard code 90 angle
	.mclk = 24,
	.mipi_lane_num = SENSOR_MIPI_4_LANE,
	.i2c_addr_table = {0x46, 0x40, 0xff},
	.i2c_speed = 400,
};
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{ 4224, 3136,   0, 342, 4224, 2452,  4224, 2452, 480, 2, 3264, 2448, 0, 0, 3264, 2448},       // custom1 (3264 x 2448)
	{ 4224, 3136,   0, 342, 4224, 2452,  4224, 2452, 480, 2, 3264, 2448, 0, 0, 3264, 2448},       // custom2 (3264 x 2448)
	{ 4224, 3136,   0, 342, 4224, 2452,  4224, 2452, 480, 2, 3264, 2448, 0, 0, 3264, 2448},       // custom3 (3264 x 2448)
	{ 4224, 3136,   0, 342, 4224, 2452,  4224, 2452, 480, 2, 3264, 2448, 0, 0, 3264, 2448},       // custom4 (3264 x 2448)
	{ 4224, 3136,   0, 342, 4224, 2452,  4224, 2452, 480, 2, 3264, 2448, 0, 0, 3264, 2448},       // custom5 (3264 x 2448)
};
...
static kal_uint16 hi1336sunny_table_write_cmos_sensor(
...
static kal_uint8 get_vendor_id(void)
{
	...
	kal_uint16 addr = 0x0001;				//Address of vendor id
...
static kal_uint32 return_sensor_id(void)
{
	...
	if (vendor_id == 0x01)
		return ((read_cmos_sensor(0x0716) << 8) | read_cmos_sensor(0x0717)) + 1;	//vendor: sunny
	else
		return ((read_cmos_sensor(0x0716) << 8) | read_cmos_sensor(0x0717));		//vendor: qtech OR there is no eeprom data.
}
...
kal_uint16 addr_data_pair_init_hi1336sunny[] = {
	0x2000, 0x0021,
	0x2002, 0x04a5,
	0x2004, 0xb124,
	0x2006, 0xc09c,
...
{
	hi1336sunny_table_write_cmos_sensor(
		addr_data_pair_init_hi1336sunny,
		sizeof(addr_data_pair_init_hi1336sunny) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_preview_hi1336sunny[] = {
	0x3250, 0xa470,
	0x0730, 0x770f,
	0x0732, 0xe1b0,
	0x1118, 0x0004,
...
{
	hi1336sunny_table_write_cmos_sensor(
		addr_data_pair_preview_hi1336sunny,
		sizeof(addr_data_pair_preview_hi1336sunny) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_capture_30fps_hi1336sunny[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0006,
...
kal_uint16 addr_data_pair_capture_15fps_hi1336sunny[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0006,
...
static void capture_setting(kal_uint16 currefps)
{
	if (currefps == 300) {
	hi1336sunny_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_hi1336sunny,
		sizeof(addr_data_pair_capture_30fps_hi1336sunny) /
		sizeof(kal_uint16));

	} else {
	hi1336sunny_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_hi1336sunny,
		sizeof(addr_data_pair_capture_15fps_hi1336sunny) /
		sizeof(kal_uint16));
	}
}

kal_uint16 addr_data_pair_video_hi1336sunny[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x017e,
...
{
	hi1336sunny_table_write_cmos_sensor(
		addr_data_pair_video_hi1336sunny,
		sizeof(addr_data_pair_video_hi1336sunny) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_hs_video_hi1336sunny[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe2b0,
	0x1118, 0x01a8,
...
{
	hi1336sunny_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi1336sunny,
		sizeof(addr_data_pair_hs_video_hi1336sunny) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_slim_video_hi1336sunny[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe2b0,
	0x1118, 0x01a8,
...
{
	hi1336sunny_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi1336sunny,
		sizeof(addr_data_pair_slim_video_hi1336sunny) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_custom1_hi1336sunny[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0156,
...
{
	hi1336sunny_table_write_cmos_sensor(
		addr_data_pair_custom1_hi1336sunny,
		sizeof(addr_data_pair_custom1_hi1336sunny) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_custom2_hi1336sunny[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0156,
...
{
	hi1336sunny_table_write_cmos_sensor(
		addr_data_pair_custom2_hi1336sunny,
		sizeof(addr_data_pair_custom2_hi1336sunny) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_custom3_hi1336sunny[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0156,
...
{
	hi1336sunny_table_write_cmos_sensor(
		addr_data_pair_custom3_hi1336sunny,
		sizeof(addr_data_pair_custom3_hi1336sunny) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_custom4_hi1336sunny[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0156,
...
{
	hi1336sunny_table_write_cmos_sensor(
		addr_data_pair_custom4_hi1336sunny,
		sizeof(addr_data_pair_custom4_hi1336sunny) /
		sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_custom5_hi1336sunny[] = {
	0x3250, 0xa060,
	0x0730, 0x770f,
	0x0732, 0xe0b0,
	0x1118, 0x0156,
...
{
	hi1336sunny_table_write_cmos_sensor(
		addr_data_pair_custom5_hi1336sunny,
		sizeof(addr_data_pair_custom5_hi1336sunny) /
		sizeof(kal_uint16));
}
...
static kal_uint32 open(void)
{
	...
	LOG_INF("[open]: hi1336sunny@MT6765,MIPI 4LANE\n");
...
/*add rawinfo end*/
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		// read from e2prom
#if e2prom
		read_eeprom_sunny((kal_uint16)(*feature_data),
...
UINT32 HI1336SUNNYPD2140MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
