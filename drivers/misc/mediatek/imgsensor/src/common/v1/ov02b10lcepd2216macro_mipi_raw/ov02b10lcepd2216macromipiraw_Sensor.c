...
#include "ov02b10lcepd2216macromipiraw_Sensor.h"
#include "../imgsensor_i2c.h"
/*********************Modify Following Strings for Debug********************/
#define PFX "ov02b10lcepd2216macro_mipi_raw_camera_sensor"
...
extern kal_bool pd2216gc2375_flg;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV02B10LCEPD2216MACRO_SENSOR_ID,
	...
	.pre = {
		...
		.framelength = 1228,            //record different mode's framelength
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	...
	{  1600, 1200,   0,  0, 1600, 1200, 1600,  1200, 0, 0, 1280,  960, 0,    0, 1280,   960}, // custom1
	{  1600, 1200,	 0,  0, 1600, 1200, 1600,  1200, 0, 0, 1600, 1200, 0,    0, 1600,  1200}, // custom2
};
...
static kal_uint32 return_sensor_id(void)
{
	...
	LOG_INF("QPF current sensor is ov02b10lce");
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if((gain >= 0x40) && (gain <= (15.5*0x40))) //base gain = 0x40
	{
		...
		if(iReg<=0x10)
		{
			...
			//write_cmos_sensor(0xfd, 0x03);	//page3
			write_cmos_sensor(0xfe, 0x02);	//fresh 
			LOG_INF("OV02B10LCEPD2216MACROMIPI_SetGain = 16");
		}
		else if(iReg>= 0xf8)//gpw
		{
			...
			//write_cmos_sensor(0xfd, 0x03);	//page3
			write_cmos_sensor(0xfe, 0x02);	//fresh 
			LOG_INF("OV02B10LCEPD2216MACROMIPI_SetGain = 160");
		}
		else
		{
			write_cmos_sensor(0xfd, 0x01);
			...
			//write_cmos_sensor(0xfd, 0x03);	//page3
			write_cmos_sensor(0xfe, 0x02);	//fresh 
			LOG_INF("OV02B10LCEPD2216MACROMIPI_SetGain = %d",iReg);
		}
	}
	else
		...
		do {
			...
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				//memcpy(backaux2_cam_name, "2_malta_sun_ov02b10", 64);
...
UINT32 OV02B10LCEPD2216MACRO_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*      OV02B10LCEPD2216MACRO_MIPI_RAW_SensorInit      */
