...
extern otp_error_code_t GC02M1PD2226F_OTP_ERROR_CODE;
#endif
MUINT32  sn_inf_main2_gc02m1pd2226f[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main2_gc02m1pd2226f[4];
