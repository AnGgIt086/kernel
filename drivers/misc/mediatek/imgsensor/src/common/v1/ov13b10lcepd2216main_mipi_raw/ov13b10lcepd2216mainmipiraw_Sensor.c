...
#define PFX "ov13b10_camera_sensor_lce"
...
#include "ov13b10lcepd2216mainmipiraw_Sensor.h"
#define cam_pr_debug(format, args...)    \
	pr_err(PFX "[%s] " format, __func__, ##args)

#define OV13B10LCEPD2216MAIN_EEPROM_VENDORID_REG 0x0001
#define OV13B10LCEPD2216MAIN_EEPROM_VENDORID_VALUE 0x57

#define MULTI_WRITE 1
static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13B10LCEPD2216MAIN_SENSOR_ID,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov13b10lce[] = {
	0x0103, 0x01,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0321, 0x00,
...
static void sensor_init(void)
{
	...
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_init_ov13b10lce,
		sizeof(addr_data_pair_init_ov13b10lce) / sizeof(kal_uint16));
#else
	cam_pr_debug("E\n");
	write_cmos_sensor(0x0103, 0x01);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov13b10lce[] = {
	0x0305, 0x23,
	0x3501, 0x06,
	0x3502, 0x10,
	0x3662, 0x88, 
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_preview_ov13b10lce,
		sizeof(addr_data_pair_preview_ov13b10lce) / sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_30fps_ov13b10lce[] = {
	0x0305, 0x46,
	0x3501, 0x0c,
	0x3502, 0x10,
	0x3662, 0x92,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_ov13b10lce,
		sizeof(addr_data_pair_capture_30fps_ov13b10lce) /
		sizeof(kal_uint16));
#else
	if (currefps == 150) {
	write_cmos_sensor(0x0305, 0x46);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_ov13b10lce[] = {
	0x0305, 0x46,
	0x3501, 0x0c,
	0x3502, 0x10,
	0x3662, 0x92,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_video_ov13b10lce,
		sizeof(addr_data_pair_video_ov13b10lce) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0305, 0x46); 
	write_cmos_sensor(0x3501, 0x0c); 
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov13b10lce[] = {
	0x0305, 0x23, 
	0x3501, 0x03, 
	0x3502, 0x00, 
	0x3662, 0x88,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov13b10lce,
		sizeof(addr_data_pair_hs_video_ov13b10lce) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0305, 0x23); 
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ov13b10lce[] = {
	0x0305, 0x23, 
	0x3501, 0x03, 
	0x3502, 0x00, 
	0x3662, 0x88,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov13b10lce,
		sizeof(addr_data_pair_slim_video_ov13b10lce) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0305, 0x23); 
	write_cmos_sensor(0x3501, 0x06); 
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_ov13b10lce[] = {
	0x0305, 0x46, 
	0x3501, 0x0c, 
	0x3502, 0x10, 
	0x3662, 0x92, 
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_custom1_ov13b10lce,
		sizeof(addr_data_pair_custom1_ov13b10lce) /
		sizeof(kal_uint16));
#else
	#if 0
	write_cmos_sensor(0x0305, 0x23); 
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom3_ov13b10lce[] = {
	0x0305, 0x46, 
	0x3501, 0x0c, 
	0x3502, 0x10, 
	0x3662, 0x92, 
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_custom3_ov13b10lce,
		sizeof(addr_data_pair_custom3_ov13b10lce) /
		sizeof(kal_uint16));
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom4_ov13b10lce[] = {
	0x0305, 0x46, 
	0x3501, 0x0c, 
	0x3502, 0x10, 
	0x3662, 0x92, 
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_custom4_ov13b10lce,
		sizeof(addr_data_pair_custom4_ov13b10lce) /
		sizeof(kal_uint16));
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom5_ov13b10lce[] = {
	0x0305, 0x46, 
	0x3501, 0x0c, 
	0x3502, 0x10, 
	0x3662, 0x92, 
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_custom5_ov13b10lce,
		sizeof(addr_data_pair_custom5_ov13b10lce) /
		sizeof(kal_uint16));
#endif
}
...
static kal_uint8 get_vendor_id(void)
{
	...
	kal_uint16 addr = OV13B10LCEPD2216MAIN_EEPROM_VENDORID_REG;		  //Address of vendor id
	char pusendcmd[2] = {(char)(addr >> 8), (char)(addr & 0xFF) };
...
static kal_uint32 return_sensor_id(void)
{
	...
	if (vendor_id == OV13B10LCEPD2216MAIN_EEPROM_VENDORID_VALUE)
	{
		t_sensor_id = ((read_cmos_sensor(0x300a) << 16) | (read_cmos_sensor(0x300b) << 8) | read_cmos_sensor(0x300c));
	}else{
...
UINT32 OV13B10LCEPD2216MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
