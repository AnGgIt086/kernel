 ...
 * Filename:
 * ---------
 *     IMX355QTEPD2140MAINmipi_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "imx355qtepd2140mainmipiraw_Sensor.h"

/************************Modify Following Strings for Debug********************/
#define PFX "MAIN_IMX355QTEPD2140MAIN_camera_sensor_buyan"
#define LOG_1 LOG_INF("IMX355QTEPD2140MAIN,MIPI 4LANE\n")
/************************   Modify end    *************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX355QTEPD2140MAIN_SENSOR_ID,
...
extern int imx355qtepd2140main_otp_read(void);
extern bool imx355qtepd2140main_vivo_read_eeprom(kal_uint16 addr,  BYTE *data);
int vivo_imx355qtepd2140main_otp_read_when_power_on;
extern otp_error_code_t IMX355QTEPD2140MAIN_OTP_ERROR_CODE;
MUINT32  sn_inf_sub_imx355qtepd2140main[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_imx355qtepd2140main[4];  
...
/* if shutter bigger than frame_length, should extend frame length first */
	...
	#define IMX355QTEPD2140MAINMIPI_MaxGainIndex (389)
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	kal_uint16 iI;

	kal_uint16 imx355qtepd2140mainMIPI_sensorGainMapping[IMX355QTEPD2140MAINMIPI_MaxGainIndex][2] = {
	{64, 0},
	{65, 16},
	{66, 32},
	{67, 46},
	...
	for (iI = 0; iI < IMX355QTEPD2140MAINMIPI_MaxGainIndex; iI++) {
		if (gain <= imx355qtepd2140mainMIPI_sensorGainMapping[iI][0])
			return imx355qtepd2140mainMIPI_sensorGainMapping[iI][1];
	}

	return imx355qtepd2140mainMIPI_sensorGainMapping[iI - 1][1];
}
...
#endif
static kal_uint16 imx355qtepd2140main_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_init_imx355qtepd2140main[] = {
...
/*3264x2448@30fps*/
kal_uint16 addr_data_pair_full_size_imx355qtepd2140main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*3264x1840@30fps*/
kal_uint16 addr_data_pair_crop_size_imx355qtepd2140main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*1632x1224@30fps*/
kal_uint16 addr_data_pair_bining_size_imx355qtepd2140main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x07,
...
/*1632x1224@30fps*/
kal_uint16 addr_data_pair_slim_video_size_imx355qtepd2140main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x07,
...
/*3264x2448@30fps*/
kal_uint16 addr_data_pair_hs_video_size_imx355qtepd2140main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*3264x2448@30fps*/
kal_uint16 addr_data_pair_custom1_size_imx355qtepd2140main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*1632x1224@30fps*/
kal_uint16 addr_data_pair_custom2_size_imx355qtepd2140main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x07,
...
/*3264x2448@30fps*/
kal_uint16 addr_data_pair_custom3_size_imx355qtepd2140main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*3264x2448@20fps*/
kal_uint16 addr_data_pair_custom4_size_imx355qtepd2140main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
/*640x480@15fps*/
kal_uint16 addr_data_pair_custom5_size_imx355qtepd2140main[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x0E,
...
{
	imx355qtepd2140main_table_write_cmos_sensor(addr_data_pair_init_imx355qtepd2140main,
		sizeof(addr_data_pair_init_imx355qtepd2140main)/sizeof(kal_uint16));
}


static void full_size_setting(void)
{
	imx355qtepd2140main_table_write_cmos_sensor(addr_data_pair_full_size_imx355qtepd2140main,
	sizeof(addr_data_pair_full_size_imx355qtepd2140main) / sizeof(kal_uint16));
}

static void crop_size_setting(void)
{
	imx355qtepd2140main_table_write_cmos_sensor(addr_data_pair_crop_size_imx355qtepd2140main,
	sizeof(addr_data_pair_crop_size_imx355qtepd2140main) / sizeof(kal_uint16));
}

static void binning_size_setting(void)
{
	imx355qtepd2140main_table_write_cmos_sensor(addr_data_pair_bining_size_imx355qtepd2140main,
	sizeof(addr_data_pair_bining_size_imx355qtepd2140main) / sizeof(kal_uint16));
}

static void slim_video_size_setting(void)
{
	imx355qtepd2140main_table_write_cmos_sensor(addr_data_pair_slim_video_size_imx355qtepd2140main,
	sizeof(addr_data_pair_slim_video_size_imx355qtepd2140main) / sizeof(kal_uint16));
}

static void hs_video_size_setting(void)
{
	imx355qtepd2140main_table_write_cmos_sensor(addr_data_pair_hs_video_size_imx355qtepd2140main,
	sizeof(addr_data_pair_hs_video_size_imx355qtepd2140main) / sizeof(kal_uint16));
}

static void custom1_size_setting(void)
{
	imx355qtepd2140main_table_write_cmos_sensor(addr_data_pair_custom1_size_imx355qtepd2140main,
	sizeof(addr_data_pair_custom1_size_imx355qtepd2140main) / sizeof(kal_uint16));
}

static void custom2_size_setting(void)
{
	imx355qtepd2140main_table_write_cmos_sensor(addr_data_pair_custom2_size_imx355qtepd2140main,
	sizeof(addr_data_pair_custom2_size_imx355qtepd2140main) / sizeof(kal_uint16));
}
...
{
	imx355qtepd2140main_table_write_cmos_sensor(addr_data_pair_custom4_size_imx355qtepd2140main,
	sizeof(addr_data_pair_custom4_size_imx355qtepd2140main) / sizeof(kal_uint16));
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0/*,j = 0*/;
	kal_uint8 retry = 2;
	//unsigned char material_inf_imx355qtepd2140main[4] ={0,0,0,0};
    //int offset = 0x0F;
			...
			*sensor_id = ((read_cmos_sensor(0x0A0A) << 4) |read_cmos_sensor(0x0A0B) >> 4) + 1;
			if (*sensor_id == imgsensor_info.sensor_id) {
...
#if 0
				for(j = 0;j < 4;j++){
					imx355qtepd2140main_vivo_read_eeprom(offset,&material_inf_imx355qtepd2140main[j]);	
					offset++;
				}
				pr_info("i2c write id: 0x%x, sensor id: 0x%x material_inf_imx355qtepd2140main=0x%x\n", imgsensor.i2c_write_id,*sensor_id,((unsigned int)material_inf_imx355qtepd2140main[0]<<24|(unsigned int)material_inf_imx355qtepd2140main[1]<<16|(unsigned int)material_inf_imx355qtepd2140main[2]<<8|(unsigned int)material_inf_imx355qtepd2140main[3]));
				if((unsigned int)material_inf_imx355qtepd2140main[3] == 0x80) {
					if (*sensor_id == imgsensor_info.sensor_id) {
					LOG_INF("i2c write id: 0x%x, sensor id: 0x%x material_inf_imx355qtepd2140main=0x%x\n", imgsensor.i2c_write_id,*sensor_id,((unsigned int)material_inf_imx355qtepd2140main[0]<<24|(unsigned int)material_inf_imx355qtepd2140main[1]<<16|(unsigned int)material_inf_imx355qtepd2140main[2]<<8|(unsigned int)material_inf_imx355qtepd2140main[3]));
				//	if (is_atboot == 1) {
				...
				//	}
        				...
        				vivo_imx355qtepd2140main_otp_read_when_power_on = imx355qtepd2140main_otp_read();
        				pr_info("read eeprom ---vivo_imx355qtepd2140main_otp_read_when_power_on = %d,IMX355QTEPD2140MAIN_OTP_ERROR_CODE =%d\n", vivo_imx355qtepd2140main_otp_read_when_power_on, IMX355QTEPD2140MAIN_OTP_ERROR_CODE);
        				return ERROR_NONE;
				}
			    }else {
                                pr_err("material_inf_imx355qtepd2140main[3]=0x%x != 0x80",material_inf_imx355qtepd2140main[3] );
                                *sensor_id = 0xFFFFFFFF;
                                return ERROR_SENSOR_CONNECT_FAIL;
                        }
// #else
...
static kal_uint32 open(void)
{
	...
	kal_uint8 retry = 2;
	LOG_1;
	LOG_INF("imx355qtepd2140main open begin..\n");
	...
	if (imgsensor_info.sensor_id != sensor_id)
		return ERROR_SENSOR_CONNECT_FAIL;
	KD_SENSOR_PROFILE("imx355qtepd2140main get sensor id time");
	/* initail sequence write in  */
	global_setting();
	KD_SENSOR_PROFILE("imx355qtepd2140main set global setting time");
	...
	spin_unlock(&imgsensor_drv_lock);
	LOG_INF("imx355qtepd2140main open end..\n");
	return ERROR_NONE;
} /* open */
...
{
	LOG_INF("imx355qtepd2140main close begin..\n");
	write_cmos_sensor(0x0100, 0x00);
	return ERROR_NONE;
}
...
{
	LOG_INF("imx355qtepd2140main preview begin..\n");
	spin_lock(&imgsensor_drv_lock);
	...
	KD_SENSOR_PROFILE("imx355qtepd2140main set binning size setting time");
	return ERROR_NONE;
}
...
static kal_uint32 capture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	LOG_INF("imx355qtepd2140main preview capture..\n");
	spin_lock(&imgsensor_drv_lock);
	...
	KD_SENSOR_PROFILE_INIT();
	full_size_setting();
	KD_SENSOR_PROFILE("imx355qtepd2140main set full size setting time");
	...
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	KD_SENSOR_PROFILE_INIT();
	crop_size_setting();
	KD_SENSOR_PROFILE("imx355qtepd2140main set crop size setting time");
...
static kal_uint32 imx355qtepd2140main_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
 ...
 */
	...
	case SENSOR_FEATURE_SET_AWB_GAIN:
		imx355qtepd2140main_awb_gain(pSetSensorAWB);
		break;
	...
	{
		LOG_INF("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  IMX355QTEPD2140MAIN_OTP_ERROR_CODE:%d \n", *feature_data, IMX355QTEPD2140MAIN_OTP_ERROR_CODE);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = IMX355QTEPD2140MAIN_OTP_ERROR_CODE;
				memcpy(feature_data+2, sn_inf_sub_imx355qtepd2140main, sizeof(MUINT32)*13); 
				memcpy(feature_data+10, material_inf_sub_imx355qtepd2140main, sizeof(MUINT32)*4);
			}
			break;
		}
		break;
...
UINT32 IMX355QTEPD2140MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
