 ...
 * Filename:
 * ---------
 *	 hi556lcepd2216frontmipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#define PFX "hi556_camera_sensor_pd2216"
#define LOG_INF(format, args...)    pr_debug(PFX "[%s] " format, __func__, ##args)

static DEFINE_SPINLOCK(imgsensor_drv_lock);

extern int vivo_sub_otp_read_hi556lcepd2216front(void);
int vivo_sub_otp_read_when_power_on_hi556lcepd2216front;
// extern otp_error_code_t SUB_OTP_ERROR_CODE_HI556LCEPD2216FRONT;
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI556LCEPD2216FRONT_SENSOR_ID,
				...
				*sensor_id = return_sensor_id();
				if (*sensor_id == imgsensor_info.sensor_id) {
					LOG_INF("i2c write id  : 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
						...
						LOG_INF("[%d] add:start read eeprom ---vivo_sub_otp_read_when_power_on_hi556lcepd2216front = %d\n", __LINE__, vivo_sub_otp_read_when_power_on_hi556lcepd2216front);
						vivo_sub_otp_read_when_power_on_hi556lcepd2216front = vivo_sub_otp_read_hi556lcepd2216front();
						LOG_INF("[%d] add:start read eeprom ---vivo_sub_otp_read_when_power_on_hi556lcepd2216front = %d\n", __LINE__, vivo_sub_otp_read_when_power_on_hi556lcepd2216front);
						/* add end*/
					return ERROR_NONE;
				} else {
...
UINT32 HI556LCEPD2216FRONT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
