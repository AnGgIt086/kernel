 ...
 * Filename:
 * ---------
 *	   ov05a10qtepd2236frontmipiraw_Sensor.h
 *
 * Project:
 * --------
 *	   ALPS
 ...
 *
 ****************************************************************************/
#ifndef _OV05A10QTEPD2236FRONTMIPIMIPI_SENSOR_H
#define _OV05A10QTEPD2236FRONTMIPIMIPI_SENSOR_H
...
//typedef struct imgsensor_struct {
	...
	enum MSDK_SCENARIO_ID_ENUM current_scenario_id;	 //MSDK_SCENARIO_ID_ENUM current_scenario_id;//current scenario id
