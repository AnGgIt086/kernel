 ...
 * Filename:
 * ---------
 *	   ov05a10qtepd2236frontmipiraw_Sensor.c
 *
 * Project:
 * --------
 *	   ALPS
...
#include "ov05a10qtepd2236frontmipiraw_Sensor.h"
/****************************Modify Following Strings for Debug****************************/
#define PFX "FRONT_OV05A10QTEPD2236FRONT_camera_sensor"
#define LOG_1 LOG_INF("OV05A10QTEPD2236FRONT,MIPI 2LANE\n")
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV05A10QTEPD2236FRONT_SENSOR_ID,

	.checksum_value = 0x8e8fb430,
	.pre = {
		.pclk = 46800000,              //record different mode's pclk
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10]= {
 { 2608, 1960, 24, 20, 2560, 1920, 1280,  960, 0000, 0000, 1280,  960, 0000, 0000, 1280,  960}, // Preview 2112*1558
 { 2608, 1960, 24, 20, 2560, 1920, 2560, 1920, 0000, 0000, 2560, 1920, 0000, 0000, 2560, 1920}, // capture 4206*3128
 { 2608, 1960, 24, 20, 2560, 1920, 1280,  960, 0000, 0000, 1280,  960, 0000, 0000, 1280,  960}, // video
 { 2608, 1960, 24, 20, 2560, 1920,  640,  480, 0000, 0000,  640,  480, 0000, 0000,  640,  480}, //hight speed video
 { 2608, 1960, 24, 20, 2560, 1920, 1280,  960, 0000, 0000, 1280,  960, 0000, 0000, 1280,  960},// slim video
 { 2608, 1960, 24, 20, 2560, 1920, 1280,  960, 0000, 0000, 1280,  960, 0000, 0000, 1280,  960},//custom1
 { 2608, 1960, 24, 20, 2560, 1920, 1280,  960, 0000, 0000, 1280,  960, 0000, 0000, 1280,  960},//custom2
 { 2608, 1960, 24, 20, 2560, 1920, 1280,  960, 0000, 0000, 1280,  960, 0000, 0000, 1280,  960},//custom3
 { 2608, 1960, 24, 20, 2560, 1920, 1280,  960, 0000, 0000, 1280,  960, 0000, 0000, 1280,  960},//custom4
 { 2608, 1960, 24, 20, 2560, 1920,  640,  480, 0000, 0000,  640,  480, 0000, 0000,  640,  480},//custom5
};
...
static void set_dummy(void)
{
   LOG_INF("dummyline = %d, dummypixels = %d \n", imgsensor.dummy_line, imgsensor.dummy_pixel);
	...
	write_cmos_sensor(0x05, ((imgsensor.frame_length - imgsensor.vblank_convert)  & 0x7F00) >> 8);
	write_cmos_sensor(0x06, (imgsensor.frame_length - imgsensor.vblank_convert ) & 0xFF);
...
static void write_shutter(kal_uint16 shutter)
{
	...
	if (imgsensor.autoflicker_en) {
		...
		LOG_INF("huazai_shutter = %d == %x min_shutter=%d\n", shutter, shutter, imgsensor_info.min_shutter);
	// Update Shutter
		write_cmos_sensor(0xfd, 0x01);
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if ((gain >= BASEGAIN) && (gain <= (15.5*BASEGAIN))) {
			...
			if (reg_gain <= 0x10) {
					...
					LOG_INF("OV05A10QTEPD2236FRONTMIPI reg_gain = %d, OV05A10QTEPD2236FRONTMIPI Gain = %d", reg_gain, gain);
...
static void preview_setting(void)
{
			...
			write_cmos_sensor(0xfb, 0x4b); //43
			...
			write_cmos_sensor(0x94, 0x7d);
			write_cmos_sensor(0x95, 0x53);
			write_cmos_sensor(0x96, 0x06);
			write_cmos_sensor(0x98, 0x73);
			write_cmos_sensor(0xfd, 0x02);
			write_cmos_sensor(0x34, 0xc8);
			write_cmos_sensor(0x60, 0xff); //0x99 modify for DPC
...
//add for DPC
			...
			write_cmos_sensor(0xfd, 0x02);
			write_cmos_sensor(0xa0, 0x00);
			write_cmos_sensor(0xa1, 0x14);
			write_cmos_sensor(0xa2, 0x07);
			write_cmos_sensor(0xa3, 0x80);
			write_cmos_sensor(0xa4, 0x00);
...
static void custom3_setting(void)
{
			...
			mdelay(5); 
			write_cmos_sensor(0xfd, 0x00);
			write_cmos_sensor(0x2e, 0x1a);
			write_cmos_sensor(0x2f, 0x03);
			write_cmos_sensor(0x30, 0x13);
			write_cmos_sensor(0x34, 0x02);
			write_cmos_sensor(0xfd, 0x01);
			write_cmos_sensor(0x03, 0x03);
			write_cmos_sensor(0x04, 0xd8);
			write_cmos_sensor(0x06, 0x01);
			write_cmos_sensor(0x24, 0x80);
			write_cmos_sensor(0x39, 0x0d);
			write_cmos_sensor(0x3f, 0x02);
...
static void custom4_setting(void)
{
			...
			write_cmos_sensor(0x93, 0x03);
			write_cmos_sensor(0x14, 0x01);
			write_cmos_sensor(0x15, 0x75);
			write_cmos_sensor(0x16, 0x01);
			write_cmos_sensor(0x17, 0x75);
			write_cmos_sensor(0x18, 0xe0);
			write_cmos_sensor(0x19, 0xa0);
			write_cmos_sensor(0xfd, 0x04);
			write_cmos_sensor(0x31, 0x4b);
...
static kal_uint32 open(void)
{
	...
	// 	struct file *fp = filp_open("/mnt/sdcard/OV05A10QTEPD2236FRONT_sd", O_RDONLY, 0);
	// 	  if (IS_ERR(fp)) {
	// 		 fromsd = 0;
	...
	// 	} else {
	// 		fromsd = 1;
	// 		  //OV05A10QTEPD2236FRONTMIPI_Initialize_from_T_Flash();
	// 		  printk("gpww read ok!\n");
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	imgsensor.vblank_convert = 998;  //add for 1280X960@30fps
	imgsensor.pclk = imgsensor_info.pre.pclk;
						  ...
						  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	imgsensor.vblank_convert = 1994;  //add for 2560X1920@30fps
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	imgsensor.vblank_convert = 998;  //add for 640X480@30fps
	...
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	imgsensor.vblank_convert = 998;  //add for 1280X960@24fps
	...
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	imgsensor.vblank_convert = 998;  //add for 1280X960@20fps
	...
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	imgsensor.vblank_convert = 998;  //add for 640X480@15fps
...
UINT32 OV05A10QTEPD2236FRONT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
} 	 /*	   OV05A10QTEPD2236FRONTMIPISensorInit	*/
