...
#include "gc08a3sunpd2140mainmipiraw_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc08a3sunpd2140mainmipiraw_Sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC08A3SUNPD2140MAIN_SENSOR_ID,
...
static kal_uint32 return_sensor_id(void)
{
	...
	LOG_INF("QPF current sensor is not sun_main");
	}
...
UINT32 GC08A3SUNPD2140MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
