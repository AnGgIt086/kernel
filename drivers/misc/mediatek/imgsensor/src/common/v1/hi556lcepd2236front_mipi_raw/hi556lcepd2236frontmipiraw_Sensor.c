 ...
 * Filename:
 * ---------
 *	 hi556lcepd2236frontmipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#define PFX "hi556_camera_sensor_pd2236"
#define LOG_INF(format, args...)    pr_debug(PFX "[%s] " format, __func__, ##args)

static DEFINE_SPINLOCK(imgsensor_drv_lock);

extern int vivo_sub_otp_read_hi556lcepd2236front(void);
int vivo_sub_otp_read_when_power_on_hi556lcepd2236front;
// extern otp_error_code_t SUB_OTP_ERROR_CODE_HI556LCEPD2236FRONT;
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI556LCEPD2236FRONT_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
 ...
 { 2608, 1960,  0,   16,   2608, 1928,   1304, 964,   12, 2, 1280,  960,   0, 0, 1280,  960},	// preview
 { 2608, 1960,  0,   18,   2608, 1924,   2608, 1924,  24, 2, 2560, 1920,   0, 0, 2560, 1920},	// capture
 { 2608, 1960,  0,   16,   2608, 1928,   1304, 964,   12, 2, 1280,  960,   0, 0, 1280,  960},	// video
 { 2608, 1960,  0,  496,   2608,  968,   1304, 484,  332, 2,  640,  480,   0, 0,  640,  480},	// high speed video
 { 2608, 1960,  0,   16,   2608, 1928,   1304, 964,   12, 2, 1280,  960,   0, 0, 1280,  960},	// slim video
 { 2608, 1960,  0,   16,   2608, 1928,   1304, 964,   12, 2, 1280,  960,   0, 0, 1280,  960},   // custom1
...
//Image size	  : 1280x960
//MCLK/VTCLK	  : 26MHz
//MIPI speed(Mbps): 439.84Mbps x 2Lane
//Frame Length	  : 2082
//Line Length 	  : 2816
//Max Fps 	  : 30fps
...
//MCLK		  : 26MHz
//MIPI speed(Mbps): 879.67Mbps x 2Lane
//Frame Length	  : 2082
//Line Length 	  : 2816
//Max Fps 	  : 30fps
//Pixel order 	  : Green 1st (=GR)
...
//Image size	  : 640x480
//MCLK		  : 26MHz
//MIPI speed(Mbps): 219.92Mbps x 2Lane
//Frame Length	  : 2082
//Line Length 	  : 2816
//Max Fps 	  : 30fps
//Pixel order 	  : Green 1st (=GR)
...
//Image size	  : 1280x960
//MCLK/VTCLK	  : 26MHz
//MIPI speed(Mbps): 439.835Mbps x 2Lane
//Frame Length	  : 2603
//Line Length 	  : 2816
//Max Fps 	  : 24fps
//Pixel order 	  : Green 1st (=GR)
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	kal_uint8 timeout = 0;
	timeout = check_i2c_timeout(0x0F16, imgsensor.i2c_write_id);
	if (timeout) {
				...
				*sensor_id = return_sensor_id();
				if (*sensor_id == imgsensor_info.sensor_id) {
					LOG_INF("i2c write id  : 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
						...
						LOG_INF("[%d] add:start read eeprom ---vivo_sub_otp_read_when_power_on_hi556lcepd2236front = %d\n", __LINE__, vivo_sub_otp_read_when_power_on_hi556lcepd2236front);
						vivo_sub_otp_read_when_power_on_hi556lcepd2236front = vivo_sub_otp_read_hi556lcepd2236front();
						LOG_INF("[%d] add:start read eeprom ---vivo_sub_otp_read_when_power_on_hi556lcepd2236front = %d\n", __LINE__, vivo_sub_otp_read_when_power_on_hi556lcepd2236front);
						/* add end*/
					return ERROR_NONE;
				} else {
...
UINT32 HI556LCEPD2236FRONT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
