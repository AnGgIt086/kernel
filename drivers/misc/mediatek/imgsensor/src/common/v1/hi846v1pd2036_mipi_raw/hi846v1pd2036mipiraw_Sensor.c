...
#define PFX "SUBV1[0848]_camera_sensor"
...
#include "hi846v1pd2036mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI846V1PD2036_SENSOR_ID,
...
extern int sub_848_otp_read(void);
int subv1_otp_read_when_power_on;
extern otp_error_code_t SUB_OTP_ERROR_CODE_848;
MUINT32  sn_inf_sub_hi846v1pd2036[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_hi846v1pd2036[4];  
			...
			do {
				*sensor_id = return_sensor_id() + 2;
				if (*sensor_id == imgsensor_info.sensor_id) {				
					...
					/*vivo caofeixiang add for CameraEM otp errorcode*/
					PK_DBG("cfx_add:start read eeprom ---subv1_otp_read_when_power_on = %d\n", subv1_otp_read_when_power_on);
					subv1_otp_read_when_power_on = sub_848_otp_read();
					PK_DBG("cfx_add:end read eeprom ---subv1_otp_read_when_power_on = %d,SUB_OTP_ERROR_CODE_848 =%d\n", subv1_otp_read_when_power_on,SUB_OTP_ERROR_CODE_848);
					/*vivo caofeixiang add end*/
					return ERROR_NONE;
				}	
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	(struct SENSOR_WINSIZE_INFO_STRUCT *) (uintptr_t) (*(feature_data + 1));
        ...
        case SENSOR_FEATURE_GET_CUSTOM_INFO:
		    PK_DBG("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  SUB_OTP_ERROR_CODE_848:%d \n", *feature_data,SUB_OTP_ERROR_CODE_848);
			switch (*feature_data) {
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = SUB_OTP_ERROR_CODE_848;//otp_state
					memcpy( feature_data+2, sn_inf_sub_hi846v1pd2036, sizeof(MUINT32)*13); 
					memcpy( feature_data+10, material_inf_sub_hi846v1pd2036, sizeof(MUINT32)*4); 
					#if 0
							for (i = 0 ; i<12 ; i++ ){
							printk("sn_inf_sub_hi846v1pd2036[%d]= 0x%x\n", i, sn_inf_sub_hi846v1pd2036[i]);
							}
...
UINT32 HI846V1PD2036_MIPI_RAW_SensorInit(
