 ...
 * Filename:
 * ---------
 *     gc2375cxtpd2216macromipi_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "gc2375cxtpd2216macromipiraw_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "GC2375CXTPD2216MACRO_camera_sensor"
#define LOG_1 LOG_INF("GC2375CXTPD2216MACRO, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
kal_bool pd2216gc2375_flg = 0;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC2375CXTPD2216MACRO_SENSOR_ID,
...
static kal_uint32 return_sensor_id(void)
{
	...
	LOG_INF("QPF current sensor is not cxt_macro");
	}
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0xf9, 0x46);//0x42
	...
	write_cmos_sensor(0x2b, 0x07);//08 for mipi test (hs data eot fail20220727)
	write_cmos_sensor(0xfe, 0x00);
}
...
UINT32 GC2375CXTPD2216MACRO_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
