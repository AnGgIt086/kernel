 ...
 * Filename:
 * ---------
 *	 s5k4h7lcepd2216mainmipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#define PFX "S5K4H7LCEPD2216MAIN_camera_sensor"
...
#define S5K4H7_LCE_VENDOR_ID 0x57
static DEFINE_SPINLOCK(imgsensor_drv_lock);
int Current_frame_length = 0;

static struct imgsensor_info_struct imgsensor_info = {
      .sensor_id = S5K4H7LCEPD2216MAIN_SENSOR_ID,
...
extern int S5K4H7LCEPD2216MAIN_otp_read(void);
int vivo_main_otp_read_when_power_on_s5k4h7lcepd2216main;
extern unsigned int is_atboot;
MUINT32  sn_inf_main_s5k4h7lcepd2216main[13];  /*0 flag   1-12 data*/
//vivo hope add end
#if 0
static kal_uint16 read_cmos_sensor(kal_uint32 addr)
{
...
kal_uint16 addr_data_pair_init_s5k4h7lcepd2216main[] = {
	0x0100,0x00,
	0x0000,0x12,
	0x0000,0x48,
	0x0A02,0x15,
...
kal_uint16 addr_data_pair_preview_s5k4h7lcepd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_capture_s5k4h7lcepd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_normal_video_s5k4h7lcepd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_hs_video_s5k4h7lcepd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_slim_video_s5k4h7lcepd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_custom1_s5k4h7lcepd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_custom2_s5k4h7lcepd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_custom3_s5k4h7lcepd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_custom4_s5k4h7lcepd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_custom5_s5k4h7lcepd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
{	
  ...
  table_write_cmos_sensor(addr_data_pair_init_s5k4h7lcepd2216main,
                          sizeof(addr_data_pair_init_s5k4h7lcepd2216main) / sizeof(kal_uint16));
}				/*      sensor_init  */

static void preview_setting(void)
{	
  pr_debug("preview_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_preview_s5k4h7lcepd2216main,
                          sizeof(addr_data_pair_preview_s5k4h7lcepd2216main) / sizeof(kal_uint16));
}				/*      preview_setting  */
...
static void capture_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_capture_s5k4h7lcepd2216main,
                          sizeof(addr_data_pair_capture_s5k4h7lcepd2216main) / sizeof(kal_uint16));
}
...
static void normal_video_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_normal_video_s5k4h7lcepd2216main,
                          sizeof(addr_data_pair_normal_video_s5k4h7lcepd2216main) / sizeof(kal_uint16));
}

static void hs_video_setting(void)
{
  pr_debug("hs_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_hs_video_s5k4h7lcepd2216main,
                          sizeof(addr_data_pair_hs_video_s5k4h7lcepd2216main) / sizeof(kal_uint16));
}

static void slim_video_setting(void)
{
  pr_debug("slim_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_slim_video_s5k4h7lcepd2216main,
                          sizeof(addr_data_pair_slim_video_s5k4h7lcepd2216main) / sizeof(kal_uint16));
...
static void custom1_setting(void)
{
  ...
  table_write_cmos_sensor(addr_data_pair_custom1_s5k4h7lcepd2216main,
                          sizeof(addr_data_pair_custom1_s5k4h7lcepd2216main) / sizeof(kal_uint16));
...
static void custom2_setting(void)
{
  ...
  table_write_cmos_sensor(addr_data_pair_custom2_s5k4h7lcepd2216main,
                          sizeof(addr_data_pair_custom2_s5k4h7lcepd2216main) / sizeof(kal_uint16));
...
static void custom3_setting(void)
{
  ...
  table_write_cmos_sensor(addr_data_pair_custom3_s5k4h7lcepd2216main,
                          sizeof(addr_data_pair_custom3_s5k4h7lcepd2216main) / sizeof(kal_uint16));
...
static void custom4_setting(void)
{
  ...
  table_write_cmos_sensor(addr_data_pair_custom4_s5k4h7lcepd2216main,
                          sizeof(addr_data_pair_custom4_s5k4h7lcepd2216main) / sizeof(kal_uint16));
...
static void custom5_setting(void)
{
  ...
  table_write_cmos_sensor(addr_data_pair_custom5_s5k4h7lcepd2216main,
                          sizeof(addr_data_pair_custom5_s5k4h7lcepd2216main) / sizeof(kal_uint16));
    ...
    do {
      *sensor_id = ((read_cmos_sensor_16_8(0x0000) << 8) | read_cmos_sensor_16_8(0x0001));
      ...
      if (*sensor_id == imgsensor_info.sensor_id) {
        ...
        sensor_init();
        vivo_main_otp_read_when_power_on_s5k4h7lcepd2216main=S5K4H7LCEPD2216MAIN_otp_read();
        pr_debug("add:end read eeprom - when_power_on = %d\n",vivo_main_otp_read_when_power_on_s5k4h7lcepd2216main);
        if (vivo_main_otp_read_when_power_on_s5k4h7lcepd2216main && otp_data_vendor_read_s5k4h7lcepd2216main[0] == S5K4H7_LCE_VENDOR_ID) {
        //vivo hope add end
            pr_debug("i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
            return ERROR_NONE;
        } else {
            pr_err("vendor id = 0x%x\n", otp_data_vendor_read_s5k4h7lcepd2216main[0]);
            *sensor_id = 0xFFFFFFFF;
            return ERROR_SENSOR_CONNECT_FAIL;
        }
    }
...
UINT32 S5K4H7LCEPD2216MAIN_MIPI_RAW_SensorInit(
