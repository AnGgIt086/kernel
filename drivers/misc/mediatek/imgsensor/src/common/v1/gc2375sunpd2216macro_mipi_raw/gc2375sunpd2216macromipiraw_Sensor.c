 ...
 * Filename:
 * ---------
 *     gc2375sunpd2216macromipi_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "gc2375sunpd2216macromipiraw_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "GC2375SUNPD2216MACRO_camera_sensor"
#define LOG_1 LOG_INF("GC2375SUNPD2216MACRO, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/

#define LOG_INF(format, args...)    pr_debug(PFX "[%s] " format, __func__, ##args)

static DEFINE_SPINLOCK(imgsensor_drv_lock);
kal_bool GC2375SUNPD2216MACRODuringTestPattern = KAL_FALSE;
extern kal_bool pd2216gc2375_flg;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC2375SUNPD2216MACRO_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	...
	{1600, 1200, 0, 0, 1600, 1200, 1600, 1200, 0000, 0000, 1600, 1200, 0, 0, 1600, 1200},  /* Custom 2 */
};
...
static void custom1_setting(void)
{
	...
	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0x90, 0x01);
	write_cmos_sensor(0x92, 0x7c);
	write_cmos_sensor(0x94, 0xa4);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	kal_uint8 timeout = 0;
	timeout = check_i2c_timeout(0xf1, imgsensor.i2c_write_id);
	if (timeout) {
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	GC2375SUNPD2216MACRODuringTestPattern = KAL_FALSE;
	return ERROR_NONE;
}
...
UINT32 GC2375SUNPD2216MACRO_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
