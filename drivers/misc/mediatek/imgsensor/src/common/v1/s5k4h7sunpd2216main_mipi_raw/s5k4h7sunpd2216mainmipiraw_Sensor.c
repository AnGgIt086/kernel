 ...
 * Filename:
 * ---------
 *	 s5k4h7sunpd2216mainmipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#define PFX "S5K4H7SUNPD2216MAIN_camera_sensor"
...
#include "s5k4h7sunpd2216mainmipiraw_Sensor.h"
...
#define S5K4H7PD2216MAIN_SUN_EEPROM_VENDOR_ADDR 0x0001
#define S5K4H7_SUN_VENDOR_ID	0x01

static DEFINE_SPINLOCK(imgsensor_drv_lock);
int s5k4h7sun_Current_frame_length = 0;

static struct imgsensor_info_struct imgsensor_info = {
      .sensor_id = S5K4H7SUNPD2216MAIN_SENSOR_ID,
      ...
      .pre = {
			...
			.max_framerate = 300,
			.mipi_pixel_rate = 280000000,//700M x 4 / 10
              },
      .cap = {
			.pclk = 280000000,
			.linelength = 3688,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
		{ 3264, 2448, 0, 0000, 3264, 2448, 1632, 1224, 0, 0, 1632, 1224, 0, 0, 1632, 1224}, // Preview
		{ 3264, 2448, 0, 0000, 3264, 2448, 3264, 2448, 0, 0, 3264, 2448, 0, 0, 3264, 2448}, // capture
		{ 3264, 2448, 0, 0000, 3264, 2448, 1632, 1224, 0, 0, 1632, 1224, 0, 0, 1632, 1224}, // normal_video
		{ 3264, 2448, 0, 0000, 3264, 2448, 3264, 2448, 0, 0, 3264, 2448, 0, 0, 3264, 2448}, // high speed video
		{ 3264, 2448, 0, 0000, 3264, 2448, 1632, 1224, 0, 0, 1632, 1224, 0, 0, 1632, 1224}, // slim video
		{ 3264, 2448, 0, 0000, 3264, 2448, 3264, 2448, 0, 0, 3264, 2448, 0, 0, 3264, 2448}, // custom1
		{ 3264, 2448, 0, 0000, 3264, 2448, 1632, 1224, 0, 0, 1632, 1224, 0, 0, 1632, 1224}, // custom2
		{ 3264, 2448, 0, 0000, 3264, 2448, 3264, 2448, 0, 0, 3264, 2448, 0, 0, 3264, 2448}, // custom3
		{ 3264, 2448, 0, 0000, 3264, 2448, 3264, 2448, 0, 0, 3264, 2448, 0, 0, 3264, 2448}, // custom4
		{ 3264, 2448, 0, 0000, 3264, 2448, 3264, 2448, 0, 0, 3264, 2448, 0, 0, 3264, 2448}, // custom5
};// slim video
...
MUINT32  sn_inf_main_s5k4h7sunpd2216main[13];  /*0 flag   1-12 data*/
//vivo hope add end
#if 0
static kal_uint16 read_cmos_sensor(kal_uint32 addr)
{
  ...
  if(imgsensor.sensor_mode == IMGSENSOR_MODE_HIGH_SPEED_VIDEO)
    {
	  ...
	  if(s5k4h7sun_Current_frame_length >imgsensor.frame_length)
	  {
	     write_cmos_sensor_16_8(0x0341, imgsensor.frame_length & 0xFF);
		 write_cmos_sensor_16_8(0x0340, imgsensor.frame_length >> 8);
	  }
	  ...
	  s5k4h7sun_Current_frame_length =imgsensor.frame_length ;      
...
kal_uint16 addr_data_pair_init_s5k4h7sunpd2216main[] = {
	0x0100,0x00,
	0x0000,0x12,
	0x0000,0x48,
	0x0A02,0x15,
...
kal_uint16 addr_data_pair_preview_s5k4h7sunpd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_capture_s5k4h7sunpd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_normal_video_s5k4h7sunpd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_hs_video_s5k4h7sunpd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_slim_video_s5k4h7sunpd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_custom1_s5k4h7sunpd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_custom2_s5k4h7sunpd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_custom3_s5k4h7sunpd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_custom4_s5k4h7sunpd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
kal_uint16 addr_data_pair_custom5_s5k4h7sunpd2216main[] = {
	0x0100,0x00,
	0x0136,0x18,
	0x0137,0x00,
	0x0305,0x06,
...
{	
  ...
  table_write_cmos_sensor(addr_data_pair_init_s5k4h7sunpd2216main,
                          sizeof(addr_data_pair_init_s5k4h7sunpd2216main) / sizeof(kal_uint16));
}				/*      sensor_init  */

static void preview_setting(void)
{	
  pr_debug("preview_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_preview_s5k4h7sunpd2216main,
                          sizeof(addr_data_pair_preview_s5k4h7sunpd2216main) / sizeof(kal_uint16));
}				/*      preview_setting  */
...
static void capture_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_capture_s5k4h7sunpd2216main,
                          sizeof(addr_data_pair_capture_s5k4h7sunpd2216main) / sizeof(kal_uint16));
}
...
static void normal_video_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_normal_video_s5k4h7sunpd2216main,
                          sizeof(addr_data_pair_normal_video_s5k4h7sunpd2216main) / sizeof(kal_uint16));
}

static void hs_video_setting(void)
{
  pr_debug("hs_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_hs_video_s5k4h7sunpd2216main,
                          sizeof(addr_data_pair_hs_video_s5k4h7sunpd2216main) / sizeof(kal_uint16));
}

static void slim_video_setting(void)
{
  pr_debug("slim_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_slim_video_s5k4h7sunpd2216main,
                          sizeof(addr_data_pair_slim_video_s5k4h7sunpd2216main) / sizeof(kal_uint16));
...
static void custom1_setting(void)
{
  ...
  table_write_cmos_sensor(addr_data_pair_custom1_s5k4h7sunpd2216main,
                          sizeof(addr_data_pair_custom1_s5k4h7sunpd2216main) / sizeof(kal_uint16));
...
static void custom2_setting(void)
{
  ...
  table_write_cmos_sensor(addr_data_pair_custom2_s5k4h7sunpd2216main,
                          sizeof(addr_data_pair_custom2_s5k4h7sunpd2216main) / sizeof(kal_uint16));
...
static void custom3_setting(void)
{
  ...
  table_write_cmos_sensor(addr_data_pair_custom3_s5k4h7sunpd2216main,
                          sizeof(addr_data_pair_custom3_s5k4h7sunpd2216main) / sizeof(kal_uint16));
...
static void custom4_setting(void)
{
  ...
  table_write_cmos_sensor(addr_data_pair_custom4_s5k4h7sunpd2216main,
                          sizeof(addr_data_pair_custom4_s5k4h7sunpd2216main) / sizeof(kal_uint16));
...
static void custom5_setting(void)
{
  ...
  table_write_cmos_sensor(addr_data_pair_custom5_s5k4h7sunpd2216main,
                          sizeof(addr_data_pair_custom5_s5k4h7sunpd2216main) / sizeof(kal_uint16));
...
{
	kal_uint16 get_byte = 0;
	kal_uint32 addr = S5K4H7PD2216MAIN_SUN_EEPROM_VENDOR_ADDR;
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
  ...
  while (imgsensor_info.i2c_addr_table[i] != 0xff) {
    ...
    do {
	  ...
	  pr_info("vendor id = 0x%x", vendorid);
	  if (vendorid == S5K4H7_SUN_VENDOR_ID) {
		*sensor_id = ((read_cmos_sensor_16_8(0x0000) << 8) | read_cmos_sensor_16_8(0x0001) + 1);
		...
		pr_debug("i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
				...
				*sensor_id = 0xFFFFFFFF;
				pr_err("current sensor is not S5K4H7_SUN, vendor id = 0x%x", vendorid);
		}
...
static kal_uint32 open(void)
{
  ...
  while (imgsensor_info.i2c_addr_table[i] != 0xff) {
    ...
    do {
      ...
      pr_debug("Read sensor id fail, id: 0x%x,0x%x\n", imgsensor.i2c_write_id,sensor_id);
      retry--;
    } while (retry > 0);
    i++;
    if (sensor_id == imgsensor_info.sensor_id)
...
UINT32 S5K4H7SUNPD2216MAIN_MIPI_RAW_SensorInit(
