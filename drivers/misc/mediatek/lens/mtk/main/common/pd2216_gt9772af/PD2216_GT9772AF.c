...
/* ////////////////////////////////////////////////////////////// */
long PD2216_GT9772AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
	switch (a_u4Command) {
...
int PD2216_GT9772AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	printk("Start\n");
...
int PD2216_GT9772AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
...
int PD2216_GT9772AF_GetFileName(unsigned char *pFileName)
{
