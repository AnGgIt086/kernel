...
#define IMX258_GT9772AF_SetI2Cclient IMX258_GT9772AF_SetI2Cclient_Main
#define IMX258_GT9772AF_Ioctl IMX258_GT9772AF_Ioctl_Main
#define IMX258_GT9772AF_Release IMX258_GT9772AF_Release_Main
#define IMX258_GT9772AF_GetFileName IMX258_GT9772AF_GetFileName_Main
extern int IMX258_GT9772AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long IMX258_GT9772AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int IMX258_GT9772AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int IMX258_GT9772AF_GetFileName(unsigned char *pFileName);
...
//PD2216F start
#define PD2216_JD5510QE4AF_SetI2Cclient PD2216_JD5510QE4AF_SetI2Cclient_Main
#define PD2216_JD5510QE4AF_Ioctl PD2216_JD5510QE4AF_Ioctl_Main
#define PD2216_JD5510QE4AF_Release PD2216_JD5510QE4AF_Release_Main
#define PD2216_JD5510QE4AF_GetFileName PD2216_JD5510QE4AF_GetFileName_Main
extern int PD2216_JD5510QE4AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long PD2216_JD5510QE4AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int PD2216_JD5510QE4AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int PD2216_JD5510QE4AF_GetFileName(unsigned char *pFileName);

#define PD2216_GT9769SAF_SetI2Cclient PD2216_GT9769SAF_SetI2Cclient_Main
#define PD2216_GT9769SAF_Ioctl PD2216_GT9769SAF_Ioctl_Main
#define PD2216_GT9769SAF_Release PD2216_GT9769SAF_Release_Main
#define PD2216_GT9769SAF_GetFileName PD2216_GT9769SAF_GetFileName_Main
extern int PD2216_GT9769SAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long PD2216_GT9769SAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int PD2216_GT9769SAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int PD2216_GT9769SAF_GetFileName(unsigned char *pFileName);

#define PD2216_GT9772AF_SetI2Cclient PD2216_GT9772AF_SetI2Cclient_Main
#define PD2216_GT9772AF_Ioctl PD2216_GT9772AF_Ioctl_Main
#define PD2216_GT9772AF_Release PD2216_GT9772AF_Release_Main
#define PD2216_GT9772AF_GetFileName PD2216_GT9772AF_GetFileName_Main
extern int PD2216_GT9772AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long PD2216_GT9772AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int PD2216_GT9772AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int PD2216_GT9772AF_GetFileName(unsigned char *pFileName);

#define PD2216_PE918AF_SetI2Cclient PD2216_PE918AF_SetI2Cclient_Main
#define PD2216_PE918AF_Ioctl PD2216_PE918AF_Ioctl_Main
#define PD2216_PE918AF_Release PD2216_PE918AF_Release_Main
#define PD2216_PE918AF_GetFileName PD2216_PE918AF_GetFileName_Main
extern int PD2216_PE918AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long PD2216_PE918AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int PD2216_PE918AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int PD2216_PE918AF_GetFileName(unsigned char *pFileName);

#define PD2216_PE916AF_SetI2Cclient PD2216_PE916AF_SetI2Cclient_Main
#define PD2216_PE916AF_Ioctl PD2216_PE916AF_Ioctl_Main
#define PD2216_PE916AF_Release PD2216_PE916AF_Release_Main
#define PD2216_PE916AF_GetFileName PD2216_PE916AF_GetFileName_Main
extern int PD2216_PE916AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long PD2216_PE916AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int PD2216_PE916AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int PD2216_PE916AF_GetFileName(unsigned char *pFileName);
//PD2216F end

/*PD2236F*/
#define PD2236_AW86017AF_SetI2Cclient PD2236_AW86017AF_SetI2Cclient_Main
#define PD2236_AW86017AF_Ioctl PD2236_AW86017AF_Ioctl_Main
#define PD2236_AW86017AF_Release PD2236_AW86017AF_Release_Main
#define PD2236_AW86017AF_GetFileName PD2236_AW86017AF_GetFileName_Main
extern int PD2236_AW86017AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long PD2236_AW86017AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int PD2236_AW86017AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int PD2236_AW86017AF_GetFileName(unsigned char *pFileName);

#define PD2236_JD5510QE4AF_SetI2Cclient PD2236_JD5510QE4AF_SetI2Cclient_Main
#define PD2236_JD5510QE4AF_Ioctl PD2236_JD5510QE4AF_Ioctl_Main
#define PD2236_JD5510QE4AF_Release PD2236_JD5510QE4AF_Release_Main
#define PD2236_JD5510QE4AF_GetFileName PD2236_JD5510QE4AF_GetFileName_Main
extern int PD2236_JD5510QE4AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long PD2236_JD5510QE4AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int PD2236_JD5510QE4AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int PD2236_JD5510QE4AF_GetFileName(unsigned char *pFileName);

#define PD2236_GT9772AF_SetI2Cclient PD2236_GT9772AF_SetI2Cclient_Main
#define PD2236_GT9772AF_Ioctl PD2236_GT9772AF_Ioctl_Main
#define PD2236_GT9772AF_Release PD2236_GT9772AF_Release_Main
#define PD2236_GT9772AF_GetFileName PD2236_GT9772AF_GetFileName_Main
extern int PD2236_GT9772AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long PD2236_GT9772AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int PD2236_GT9772AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int PD2236_GT9772AF_GetFileName(unsigned char *pFileName);
/*PD2236F END*/
#endif
