...
/*
		...
		//pr_notice("\n");
		if (of_get_property(np, "PD2036F_EX_11.0", NULL)) {
			//if (*(version + 2) == '0') {
				mmc->fast_power_off = true;
				pr_notice("[msdc%d]: in fast_power_off mode", mmc->index);
			//}
		} else if (of_get_property(np, "PD1901F_EX", NULL)) {
			//if (*(version + 2) == '0') {
				mmc->fast_power_off = true;
				pr_notice("[msdc%d]: in fast_power_off mode", mmc->index);
			//}
			...
			//if (*(version + 2) == '0') {
				...
				pr_notice("[msdc%d]: in fast_power_off mode", mmc->index);
			//}
		} else if (of_get_property(np, "PD2074F_EX", NULL)) {
			//if (*(version + 2) == '0') {
				mmc->fast_power_off = true;
				pr_notice("[msdc%d]: in fast_power_off mode", mmc->index);
			//}
		} else if (of_get_property(np, "PD1901BF_EX_11.0", NULL)) {
			//if (*(version + 2) == '0') {
				mmc->fast_power_off = true;
				pr_notice("[msdc%d]: in fast_power_off mode", mmc->index);
			//}
		} else if (of_get_property(np, "PD2139F_EX", NULL)) {
			//if (*(version + 2) == '0') {
				mmc->fast_power_off = true;
				pr_notice("[msdc%d]: in fast_power_off mode", mmc->index);
			//}
		} else if (of_get_property(np, "PD2140F_EX", NULL)) {
			//if (*(version + 2) == '0') {
				mmc->fast_power_off = true;
				pr_notice("[msdc%d]: in fast_power_off mode", mmc->index);
			//}
		} else if (of_get_property(np, "PD2140", NULL)) {
			//if (*(version + 2) == '0') {
				mmc->fast_power_off = true;
				pr_notice("[msdc%d]: in fast_power_off mode", mmc->index);
			//}
		} else if (of_get_property(np, "PD2140IF_EX", NULL)) {
			//if (*(version + 2) == '0') {
				mmc->fast_power_off = true;
				pr_notice("[msdc%d]: in fast_power_off mode", mmc->index);
			//}
		} else if (of_get_property(np, "PD2140JF_EX", NULL)) {
			//if (*(version + 2) == '0') {
				mmc->fast_power_off = true;
				pr_notice("[msdc%d]: in fast_power_off mode", mmc->index);
			//}
		//BSP memory add for mmc driver strength --start
		} else if (of_get_property(np, "PD2213F_EX", NULL)) {
			//if (*(version + 2) == '0') {
				mmc->fast_power_off = true;
				pr_notice("[msdc%d]: in fast_power_off mode", mmc->index);
			//}
		//BSP memory add for mmc driver strength --end
		} else if (of_get_property(np, "PD2140NF_EX", NULL)) {
				mmc->fast_power_off = true;
				pr_notice("[msdc%d]: in fast_power_off mode", mmc->index);
		 //BSP memory add fast power mode
*/
		mmc->fast_power_off = true;
		pr_notice("[msdc%d]: in fast_power_off mode", mmc->index);
	} else
