...
//ljp modified cali re default time form 3s to 1s for optimizing production line efficiency
...
struct aw_cali_desc {
	...
	uint32_t re;		/* no ra dsp reg value*/
	uint32_t cali_re;	/*cali re show value*/
	uint32_t f0;
	uint32_t q;
	uint32_t ra;
