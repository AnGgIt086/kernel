...
/* vivo audio add for calib start */
extern char g_aw88xx_acf_name[AW_NAME_MAX];
/* vivo audio add for calib end */
...
static int aw_pid_1852_dev_init(struct aw882xx *aw882xx, int index)
{
	...
	/* vivo audio add for calib start */
	memcpy(aw_pa->acf_name, g_aw88xx_acf_name, strlen(g_aw88xx_acf_name));
	/* vivo audio add for calib end */
